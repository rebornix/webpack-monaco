...
define(["require", "exports", "assert", "path", "vs/code/node/windowsFinder", "vs/platform/windows/common/windows"], function (require, exports, assert, path, windowsFinder_1, windows_1) {
    /*---------------------------------------------------------------------------------------------
    ...
    function options(custom) {
        return __assign({ windows: [], newWindow: false, reuseWindow: false, context: windows_1.OpenContext.CLI, codeSettingsFolder: '_vscode', workspaceResolver: function (workspace) { return workspace === testWorkspace ? { id: testWorkspace.id, configPath: workspace.configPath, folders: [{ path: path.join(fixturesFolder, 'vscode_workspace_1_folder') }, { path: path.join(fixturesFolder, 'vscode_workspace_2_folder') }] } : null; } }, custom);
    }
