...
define(["require", "exports", "path", "vs/base/common/objects", "vs/base/node/profiler", "vs/nls", "vs/base/common/uri", "vs/platform/storage/node/storage", "electron", "vs/base/common/winjs.base", "vs/platform/environment/common/environment", "vs/platform/log/common/log", "vs/platform/configuration/common/configuration", "vs/platform/environment/node/argv", "vs/platform/node/product", "vs/platform/node/package", "vs/platform/windows/common/windows", "vs/base/common/lifecycle", "vs/code/electron-main/keyboard", "vs/base/common/platform", "vs/platform/workspaces/common/workspaces", "vs/platform/backup/common/backup"], function (require, exports, path, objects, profiler_1, nls, uri_1, storage_1, electron_1, winjs_base_1, environment_1, log_1, configuration_1, argv_1, product_1, package_1, windows_1, lifecycle_1, keyboard_1, platform_1, workspaces_1, backup_1) {
    'use strict';
    ...
    var CodeWindow = (function () {
        ...
        CodeWindow.prototype.registerListeners = function () {
            ...
            this.toDispose.push(this.workspaceService.onUntitledWorkspaceDeleted(function (e) { return _this.onUntitledWorkspaceDeleted(e); }));
        };
