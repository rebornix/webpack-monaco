 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "path", "fs", "vs/base/common/platform", "vs/base/common/paths", "vs/platform/windows/common/windows", "vs/platform/workspaces/common/workspaces"], function (require, exports, path, fs, platform, paths, windows_1, workspaces_1) {
    'use strict';
    ...
    function findWindowOnFilePath(windows, filePath, workspaceResolver) {
        ...
        for (var i = 0; i < workspaceWindows.length; i++) {
            ...
            if (resolvedWorkspace && resolvedWorkspace.folders.some(function (folder) { return paths.isEqualOrParent(filePath, folder.path, !platform.isLinux /* ignorecase */); })) {
                return window_1;
            }
        }
