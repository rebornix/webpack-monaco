...
define(["require", "exports", "vs/nls", "vs/base/common/platform", "vs/base/common/lifecycle", "vs/platform/extensions/common/extensionsRegistry", "vs/platform/jsonschemas/common/jsonContributionRegistry", "vs/platform/keybinding/common/abstractKeybindingService", "vs/platform/statusbar/common/statusbar", "vs/platform/keybinding/common/keybindingResolver", "vs/platform/commands/common/commands", "vs/platform/keybinding/common/keybinding", "vs/platform/contextkey/common/contextkey", "vs/platform/keybinding/common/keybindingsRegistry", "vs/platform/registry/common/platform", "vs/platform/telemetry/common/telemetry", "vs/platform/telemetry/common/telemetryUtils", "vs/platform/message/common/message", "vs/base/node/config", "vs/platform/environment/common/environment", "vs/base/browser/dom", "vs/base/browser/keyboardEvent", "vs/platform/keybinding/common/resolvedKeybindingItem", "vs/workbench/services/keybinding/common/keybindingIO", "native-keymap", "vs/workbench/services/keybinding/common/windowsKeyboardMapper", "vs/workbench/services/keybinding/common/macLinuxKeyboardMapper", "vs/workbench/services/keybinding/common/macLinuxFallbackKeyboardMapper", "vs/base/common/event", "vs/platform/configuration/common/configurationRegistry", "vs/platform/configuration/common/configuration", "vs/base/common/errors"], function (require, exports, nls, platform_1, lifecycle_1, extensionsRegistry_1, jsonContributionRegistry_1, abstractKeybindingService_1, statusbar_1, keybindingResolver_1, commands_1, keybinding_1, contextkey_1, keybindingsRegistry_1, platform_2, telemetry_1, telemetryUtils_1, message_1, config_1, environment_1, dom, keyboardEvent_1, resolvedKeybindingItem_1, keybindingIO_1, nativeKeymap, windowsKeyboardMapper_1, macLinuxKeyboardMapper_1, macLinuxFallbackKeyboardMapper_1, event_1, configurationRegistry_1, configuration_1, errors_1) {
    ...
    var KeyboardMapperFactory = (function () {
        ...
        KeyboardMapperFactory.prototype._onKeyboardLayoutChanged = function (isISOKeyboard) {
        ...
        KeyboardMapperFactory.prototype._setKeyboardData = function (isISOKeyboard, layoutInfo, rawMapping) {
        ...
        KeyboardMapperFactory._createKeyboardMapper = function (isISOKeyboard, layoutInfo, rawMapping) {
            ...
            return new macLinuxKeyboardMapper_1.MacLinuxKeyboardMapper(isISOKeyboard, isUSStandard, rawMapping, platform_1.OS);
        };
    ...
    function getDispatchConfig(configurationService) {
        var keyboard = configurationService.getConfiguration('keyboard');
    ...
    var WorkbenchKeybindingService = (function (_super) {
        ...
        function WorkbenchKeybindingService(windowElement, contextKeyService, commandService, telemetryService, messageService, environmentService, statusBarService, configurationService) {
            ...
            configurationService.onDidUpdateConfiguration(function (e) {
    ...
    if (platform_1.OS === 2 /* Macintosh */ || platform_1.OS === 3 /* Linux */) {
