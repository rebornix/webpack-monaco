    ...
    suite('Keybindings Editing', function () {
        ...
        setup(function () {
            return setUpWorkspace().then(function () {
                ...
                instantiationService.stub(configuration_1.IConfigurationService, 'getConfiguration', { 'eol': '\n' });
                ...
                instantiationService.stub(files_1.IFileService, new fileService_1.FileService(new workbenchTestServices_1.TestContextService(new workspace_1.Workspace(testDir, testDir, [uri_1.default.file(testDir)])), new testConfigurationService_1.TestConfigurationService(), { disableWatcher: true }));
        ...
        function setUpWorkspace() {
            return new winjs_base_1.TPromise(function (c, e) {
                ...
                extfs.mkdirp(testDir, 493, function (error) {
                    if (error) {
                        e(error);
                    }
                    else {
