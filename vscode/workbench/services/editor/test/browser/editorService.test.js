...
define(["require", "exports", "assert", "vs/base/common/winjs.base", "vs/base/common/paths", "vs/platform/editor/common/editor", "vs/base/common/uri", "vs/workbench/browser/parts/editor/baseEditor", "vs/workbench/common/editor", "vs/workbench/parts/files/common/editors/fileEditorInput", "vs/workbench/test/workbenchTestServices", "vs/workbench/services/editor/browser/editorService", "vs/workbench/common/editor/untitledEditorInput", "vs/workbench/common/editor/resourceEditorInput", "vs/platform/theme/test/common/testThemeService"], function (require, exports, assert, winjs_base_1, paths, editor_1, uri_1, baseEditor_1, editor_2, fileEditorInput_1, workbenchTestServices_1, editorService_1, untitledEditorInput_1, resourceEditorInput_1, testThemeService_1) {
    ...
    var TestEditorPart = (function () {
        ...
        TestEditorPart.prototype.closeEditors = function (position, filter) {
            return winjs_base_1.TPromise.as(null);
        };
        TestEditorPart.prototype.closeAllEditors = function (except) {
            return winjs_base_1.TPromise.as(null);
        };
    ...
    suite('WorkbenchEditorService', function () {
        test('basics', function () {
            ...
            var activeInput = instantiationService.createInstance(fileEditorInput_1.FileEditorInput, toFileResource.call(this, '/something.js'), void 0);
            ...
            service.openEditor({ resource: toFileResource.call(this, '/index.html'), options: { selection: { startLineNumber: 1, startColumn: 1 } } }).then(function (editor) {
                assert.strictEqual(editor, activeEditor);
                assert(openedEditorInput instanceof fileEditorInput_1.FileEditorInput);
                var contentInput = openedEditorInput;
                assert.strictEqual(contentInput.getResource().fsPath, toFileResource.call(_this, '/index.html').fsPath);
            ...
            service.openEditor({ resource: toFileResource.call(this, '/index.html'), encoding: 'utf16le', options: { selection: { startLineNumber: 1, startColumn: 1 } } }).then(function (editor) {
                assert.strictEqual(editor, activeEditor);
                assert(openedEditorInput instanceof fileEditorInput_1.FileEditorInput);
                var contentInput = openedEditorInput;
        ...
        test('caching', function () {
            ...
            var service = instantiationService.createInstance(editorService_1.WorkbenchEditorService, testEditorPart);
            // Cached Input (Files)
            var fileResource1 = toFileResource.call(this, '/foo/bar/cache1.js');
            var fileInput1 = service.createInput({ resource: fileResource1 });
            assert.ok(fileInput1);
            var fileResource2 = toFileResource.call(this, '/foo/bar/cache2.js');
