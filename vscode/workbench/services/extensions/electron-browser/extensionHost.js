...
define(["require", "exports", "vs/nls", "vs/base/common/errorMessage", "vs/base/common/marshalling", "vs/base/common/objects", "vs/base/common/uri", "vs/base/common/winjs.base", "vs/base/common/platform", "vs/base/node/ports", "vs/platform/message/common/message", "vs/platform/lifecycle/common/lifecycle", "vs/platform/windows/common/windows", "vs/platform/workspace/common/workspace", "vs/platform/telemetry/common/telemetry", "child_process", "electron", "vs/platform/node/product", "vs/platform/environment/common/environment", "vs/base/parts/ipc/node/ipc.net", "net", "vs/base/common/event", "vs/base/node/event", "vs/workbench/services/configuration/common/configuration", "vs/workbench/services/crashReporter/common/crashReporterService", "vs/platform/broadcast/electron-browser/broadcastService", "vs/base/common/paths", "vs/platform/extensions/common/extensionHost", "vs/base/common/lifecycle"], function (require, exports, nls, errorMessage_1, marshalling_1, objects, uri_1, winjs_base_1, platform_1, ports_1, message_1, lifecycle_1, windows_1, workspace_1, telemetry_1, child_process_1, electron_1, product_1, environment_1, ipc_net_1, net_1, event_1, event_2, configuration_1, crashReporterService_1, broadcastService_1, paths_1, extensionHost_1, lifecycle_2) {
    'use strict';
    Object.defineProperty(exports, "__esModule", { value: true });
    var ExtensionHostProcessWorker = (function () {
        function ExtensionHostProcessWorker(
            /* intentionally not injected */ _extensionService, _contextService, _messageService, _windowsService, _windowService, _broadcastService, _lifecycleService, _environmentService, _configurationService, _telemetryService, _crashReporterService) {
            var _this = this;
            ...
            if (!this._messageProtocol) {
                this._messageProtocol = winjs_base_1.TPromise.join([this._tryListenOnPipe(), this._tryFindDebugPort()]).then(function (data) {
                    ...
                    var opts = {
                        ...
                        execArgv: port
                            ? ['--nolazy', (_this._isExtensionDevDebugBrk ? '--inspect-brk=' : '--inspect=') + port]
                            : undefined,
                        silent: true
                    };
                    ...
                    var onStdout = event_2.fromEventEmitter(_this._extensionHostProcess.stdout, 'data');
                    var onStderr = event_2.fromEventEmitter(_this._extensionHostProcess.stderr, 'data');
                    var onOutput = event_1.any(event_1.mapEvent(onStdout, function (o) { return ({ data: "%c" + o, format: [''] }); }), event_1.mapEvent(onStderr, function (o) { return ({ data: "%c" + o, format: ['color: red'] }); }));
                    ...
                    if (_this._isExtensionDevHost && port) {
        ...
        ExtensionHostProcessWorker.prototype._tryFindDebugPort = function () {
            var _this = this;
            var extensionHostPort = this._environmentService.debugExtensionHost.port;
                ...
                return new winjs_base_1.TPromise(function (resolve, reject) {
                    ...
                    var disposable = protocol.onMessage(function (msg) {
                        if (msg === 'ready') {
                            ...
                            _this._createExtHostInitData().then(function (data) { return protocol.send(marshalling_1.stringify(data)); });
                            return;
                        }
                        if (msg === 'initialized') {
        ...
        ExtensionHostProcessWorker.prototype._createExtHostInitData = function () {
            ...
            return winjs_base_1.TPromise.join([this._telemetryService.getTelemetryInfo(), this._extensionService.getExtensions()]).then(function (_a) {
                ...
                var r = {
                    ...
                    workspace: _this._contextService.getWorkspace(),
                    extensions: extensionDescriptions,
                    configuration: _this._configurationService.getConfigurationData(),
                    telemetryInfo: telemetryInfo
                };
                return r;
            });
        };
        ExtensionHostProcessWorker.prototype._logExtensionHostMessage = function (logEntry) {
            var args = [];
            try {
            ...
            if (this._isExtensionDevTestFromCli) {
                (_a = this._windowsService).log.apply(_a, [logEntry.severity].concat(args));
            }
