...
define(["require", "exports", "vs/base/common/paths", "vs/nls", "vs/base/common/event", "vs/base/common/winjs.base", "vs/base/common/errors", "vs/base/common/mime", "vs/base/common/errorMessage", "vs/base/common/assert", "vs/base/common/lifecycle", "vs/base/common/paths", "vs/base/common/diagnostics", "vs/base/common/types", "vs/platform/lifecycle/common/lifecycle", "vs/platform/workspace/common/workspace", "vs/platform/environment/common/environment", "vs/workbench/services/textfile/common/textfiles", "vs/workbench/common/editor", "vs/workbench/common/editor/textEditorModel", "vs/workbench/services/backup/common/backup", "vs/platform/files/common/files", "vs/platform/instantiation/common/instantiation", "vs/platform/message/common/message", "vs/editor/common/services/modeService", "vs/editor/common/services/modelService", "vs/platform/telemetry/common/telemetry", "vs/platform/telemetry/common/telemetryUtils", "vs/base/common/async"], function (require, exports, path, nls, event_1, winjs_base_1, errors_1, mime_1, errorMessage_1, assert, lifecycle_1, paths, diagnostics, types, lifecycle_2, workspace_1, environment_1, textfiles_1, editor_1, textEditorModel_1, backup_1, files_1, instantiation_1, message_1, modeService_1, modelService_1, telemetry_1, telemetryUtils_1, async_1) {
    ...
    var TextFileEditorModel = (function (_super) {
        ...
        function TextFileEditorModel(resource, preferredEncoding, messageService, modeService, modelService, fileService, lifecycleService, instantiationService, telemetryService, textFileService, backupFileService, environmentService, contextService) {
        ...
        TextFileEditorModel.prototype.doCreateTextModel = function (resource, value, backup) {
            ...
            this.createTextEditorModelPromise = this.doLoadBackup(backup).then(function (backupContent) {
                ...
                return _this.createTextEditorModel(hasBackupContent ? backupContent : value, resource).then(function () {
                    ...
                    _this._installChangeContentListener();
                    return _this;
                }, function (error) {
                    _this.createTextEditorModelPromise = null;
                    return winjs_base_1.TPromise.wrapError(error);
        ...
        TextFileEditorModel.prototype._installChangeContentListener = function () {
            var _this = this;
            // See https://github.com/Microsoft/vscode/issues/30189
            // This code has been extracted to a different method because it caused a memory leak
            // where `value` was captured in the content change listener closure scope.
            this.toDispose.push(this.textEditorModel.onDidChangeContent(function () {
        ...
        TextFileEditorModel.prototype.doSave = function (versionId, options) {
            ...
            if (TextFileEditorModel.saveParticipant && this.lifecycleService.phase !== lifecycle_2.LifecyclePhase.ShuttingDown && !options.skipSaveParticipants) {
            ...
            return this.saveSequentializer.setPending(versionId, saveParticipantPromise.then(function (newVersionId) {
                ...
                if (options.force && !_this.dirty && options.reason === textfiles_1.SaveReason.EXPLICIT && versionId === newVersionId) {
        ...
        TextFileEditorModel.prototype.isSettingsFile = function () {
            ...
            if (this.contextService.hasWorkspace()) {
                return this.contextService.getWorkspace().roots.some(function (root) {
                    return paths.isEqualOrParent(_this.resource.fsPath, path.join(root.fsPath, '.vscode'));
                });
            }
            return false;
        };
