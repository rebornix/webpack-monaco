    ...
    suite('FileService', function () {
        ...
        setup(function (done) {
            ...
            extfs.copy(sourceDir, testDir, function (error) {
                ...
                service = new fileService_1.FileService(new workbenchTestServices_1.TestContextService(new workspace_1.Workspace(testDir, testDir, [uri_1.default.file(testDir)])), new testConfigurationService_1.TestConfigurationService(), { disableWatcher: true });
                done();
            });
        });
        ...
        test('options - encoding', function (done) {
            ...
            extfs.copy(_sourceDir, _testDir, function () {
                ...
                var _service = new fileService_1.FileService(new workbenchTestServices_1.TestContextService(new workspace_1.Workspace(_testDir, _testDir, [uri_1.default.file(_testDir)])), configurationService, {
        ...
        test('UTF 8 BOMs', function (done) {
            ...
            var _sourceDir = require.toUrl('./fixtures/service');
            var resource = uri_1.default.file(path.join(testDir, 'index.html'));
            var _service = new fileService_1.FileService(new workbenchTestServices_1.TestContextService(new workspace_1.Workspace(_testDir, _testDir, [uri_1.default.file(_testDir)])), new testConfigurationService_1.TestConfigurationService(), {
                disableWatcher: true
            });
            extfs.copy(_sourceDir, _testDir, function () {
