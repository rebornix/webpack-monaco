...
define(["require", "exports", "vs/base/common/winjs.base", "vs/base/parts/ipc/common/ipc", "vs/base/parts/ipc/node/ipc.cp", "vs/base/common/uri", "vs/workbench/services/files/node/watcher/common", "vs/workbench/services/files/node/watcher/nsfw/watcherIpc", "vs/base/common/lifecycle"], function (require, exports, winjs_base_1, ipc_1, ipc_cp_1, uri_1, common_1, watcherIpc_1, lifecycle_1) {
    ...
    var FileWatcher = (function () {
        ...
        FileWatcher.prototype.startWatching = function () {
            ...
            // Start watching
            this.updateRoots();
            this.toDispose.push(this.contextService.onDidChangeWorkspaceRoots(function () { return _this.updateRoots(); }));
            this.toDispose.push(this.configurationService.onDidUpdateConfiguration(function () { return _this.updateRoots(); }));
            return function () { return _this.dispose(); };
        };
        FileWatcher.prototype.updateRoots = function () {
            var _this = this;
            if (this.isDisposed) {
                return;
            }
            var roots = this.contextService.getWorkspace().roots;
            this.service.setRoots(roots.map(function (root) {
                // Fetch the root's watcherExclude setting and return it
                var configuration = _this.configurationService.getConfiguration(undefined, {
                    resource: root
                });
                var ignored = [];
