 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "chokidar", "fs", "graceful-fs", "vs/base/common/winjs.base", "vs/platform/files/common/files", "vs/base/common/async", "vs/base/common/strings", "vs/base/node/extfs", "vs/base/common/platform", "vs/workbench/services/files/node/watcher/common"], function (require, exports, chokidar, fs, gracefulFs, winjs_base_1, files_1, async_1, strings, extfs_1, platform_1, watcher) {
    'use strict';
