...
define(["require", "exports", "vs/base/browser/dom", "vs/nls", "vs/workbench/services/activity/common/activityBarService", "vs/base/common/lifecycle", "vs/platform/progress/common/progress", "vs/workbench/services/viewlet/browser/viewlet", "vs/base/browser/ui/octiconLabel/octiconLabel", "vs/platform/registry/common/platform", "vs/workbench/browser/parts/statusbar/statusbar", "vs/base/common/winjs.base", "vs/base/common/async", "vs/css!./media/progressService2"], function (require, exports, dom, nls_1, activityBarService_1, lifecycle_1, progress_1, viewlet_1, octiconLabel_1, platform_1, statusbar_1, winjs_base_1, async_1) {
    /*---------------------------------------------------------------------------------------------
    ...
    var ProgressService2 = (function () {
        ...
        ProgressService2.prototype._withViewletProgress = function (viewletId, task) {
            ...
            var delayHandle = setTimeout(function () {
                delayHandle = undefined;
                var handle = _this._activityBar.showActivity(viewletId, new activityBarService_1.ProgressBadge(function () { return ''; }), 'progress-badge');
                var startTimeVisible = Date.now();
                var minTimeVisible = 150;
                activityProgress = {
                    dispose: function () {
