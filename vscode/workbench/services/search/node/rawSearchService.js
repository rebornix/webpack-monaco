 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "fs", "path", "graceful-fs", "vs/base/common/arrays", "vs/base/common/comparers", "vs/base/common/objects", "vs/base/common/scorer", "vs/base/common/strings", "vs/base/common/winjs.base", "vs/workbench/services/search/node/fileSearch", "vs/platform/files/common/files", "vs/workbench/services/search/node/ripgrepTextSearch", "vs/workbench/services/search/node/textSearch", "vs/workbench/services/search/node/textSearchWorkerProvider"], function (require, exports, fs, path_1, gracefulFs, arrays, comparers_1, objects, scorer, strings, winjs_base_1, fileSearch_1, files_1, ripgrepTextSearch_1, textSearch_1, textSearchWorkerProvider_1) {
    'use strict';
