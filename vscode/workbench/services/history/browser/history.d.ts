...
export declare abstract class BaseHistoryService {
    ...
    constructor(editorGroupService: IEditorGroupService, editorService: IWorkbenchEditorService);
...
export declare class HistoryService extends BaseHistoryService implements IHistoryService {
    ...
    constructor(editorService: IWorkbenchEditorService, editorGroupService: IEditorGroupService, contextService: IWorkspaceContextService, storageService: IStorageService, configurationService: IConfigurationService, lifecycleService: ILifecycleService, fileService: IFileService, windowService: IWindowsService, instantiationService: IInstantiationService);
    private getExcludes(root?);
    private registerListeners();
    private onFileChanges(e);
    private onEditorClosed(event);
    reopenLastClosedEditor(): void;
    forward(acrossEditors?: boolean): void;
    private doForwardInEditors();
    private doForwardAcrossEditors();
    back(acrossEditors?: boolean): void;
    private doBackInEditors();
    private doBackAcrossEditors();
    clear(): void;
    private navigate(acrossEditors?);
    ...
    private removeFromRecentlyOpened(arg1);
