...
define(["require", "exports", "vs/base/common/event", "vs/editor/common/editorCommon", "vs/workbench/services/editor/common/editorService", "vs/workbench/common/editor", "vs/base/common/paths", "vs/editor/common/controller/cursorEvents", "vs/editor/common/model/textModelWithDecorations"], function (require, exports, event_1, editorCommon, editorService_1, editor_1, paths_1, cursorEvents_1, textModelWithDecorations_1) {
    "use strict";
    ...
    var RangeHighlightDecorations = (function () {
        ...
        RangeHighlightDecorations.prototype.getEditor = function (resourceRange) {
            ...
            if (fileResource) {
                if (paths_1.isEqual(fileResource.fsPath, resourceRange.resource.fsPath)) {
        ...
        RangeHighlightDecorations._WHOLE_LINE_RANGE_HIGHLIGHT = textModelWithDecorations_1.ModelDecorationOptions.register({
            stickiness: editorCommon.TrackedRangeStickiness.NeverGrowsWhenTypingAtEdges,
            className: 'rangeHighlight',
            isWholeLine: true
        });
        RangeHighlightDecorations._RANGE_HIGHLIGHT = textModelWithDecorations_1.ModelDecorationOptions.register({
            stickiness: editorCommon.TrackedRangeStickiness.NeverGrowsWhenTypingAtEdges,
            className: 'rangeHighlight'
        });
