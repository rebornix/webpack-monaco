...
define(["require", "exports", "assert", "vs/workbench/api/electron-browser/mainThreadDocumentsAndEditors", "./testThreadService", "vs/platform/configuration/test/common/testConfigurationService", "vs/editor/common/services/modelServiceImpl", "vs/editor/test/common/mocks/mockCodeEditorService", "vs/editor/test/common/mocks/mockCodeEditor", "vs/workbench/test/electron-browser/api/mock", "vs/base/common/event"], function (require, exports, assert, mainThreadDocumentsAndEditors_1, testThreadService_1, testConfigurationService_1, modelServiceImpl_1, mockCodeEditorService_1, mockCodeEditor_1, mock_1, event_1) {
    'use strict';
    ...
    suite('MainThreadDocumentsAndEditors', function () {
        ...
        setup(function () {
            ...
            codeEditorService = new mockCodeEditorService_1.MockCodeEditorService();
            textFileService = new (function (_super) {
            ...
            var editorGroupService = new (function (_super) {
                __extends(class_2, _super);
                function class_2() {
                    var _this = _super !== null && _super.apply(this, arguments) || this;
                    _this.onEditorsChanged = event_1.default.None;
                    _this.onEditorsMoved = event_1.default.None;
                    return _this;
                }
                return class_2;
            }(mock_1.mock()));
            documentAndEditor = new mainThreadDocumentsAndEditors_1.MainThreadDocumentsAndEditors(testThreadService_1.OneGetThreadService(new (function (_super) {
                ...
                return class_3;
            }(mock_1.mock()))), modelService, textFileService, workbenchEditorService, codeEditorService, null, null, null, null, editorGroupService, null);
        });
        ...
        test('ignore huge model from editor', function () {
            this.timeout(1000 * 60); // increase timeout for this one test
            var model = modelService.createModel(hugeModelString, null, null);
            var editor = mockCodeEditor_1.mockCodeEditor(null, { model: model, wordWrap: 'off', wordWrapMinified: false });
            assert.equal(deltas.length, 1);
            deltas.length = 0;
        ...
        test('ignore editor w/o model', function () {
            var editor = mockCodeEditor_1.mockCodeEditor([], {});
        ...
        test('editor with model', function () {
            ...
            codeEditorService.addCodeEditor(mockCodeEditor_1.mockCodeEditor(null, { model: model }));
        ...
        test('editor with dispos-ed/-ing model', function () {
            ...
            var model = modelService.createModel('farboo', null, null);
            var editor = mockCodeEditor_1.mockCodeEditor(null, { model: model });
            codeEditorService.addCodeEditor(editor);
