 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/workbench/api/electron-browser/mainThreadCommands", "vs/platform/commands/common/commands", "./testThreadService"], function (require, exports, assert, mainThreadCommands_1, commands_1, testThreadService_1) {
    'use strict';
    Object.defineProperty(exports, "__esModule", { value: true });
    suite('MainThreadCommands', function () {
        test('dispose on unregister', function () {
            var commands = new mainThreadCommands_1.MainThreadCommands(testThreadService_1.OneGetThreadService(null), undefined);
