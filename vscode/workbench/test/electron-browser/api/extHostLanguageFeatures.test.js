 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/platform/instantiation/test/common/instantiationServiceMock", "vs/base/common/errors", "vs/base/common/uri", "vs/workbench/api/node/extHostTypes", "vs/editor/common/editorCommon", "vs/editor/common/model/model", "vs/editor/common/core/position", "vs/editor/common/core/range", "./testThreadService", "vs/platform/markers/common/markers", "vs/platform/markers/common/markerService", "vs/workbench/api/node/extHostLanguageFeatures", "vs/workbench/api/electron-browser/mainThreadLanguageFeatures", "vs/workbench/api/node/extHostCommands", "vs/workbench/api/electron-browser/mainThreadCommands", "vs/workbench/api/electron-browser/mainThreadHeapService", "vs/workbench/api/node/extHostDocuments", "vs/workbench/api/node/extHostDocumentsAndEditors", "vs/editor/contrib/quickOpen/common/quickOpen", "vs/editor/common/modes", "vs/editor/contrib/codelens/browser/codelens", "vs/editor/contrib/goToDeclaration/browser/goToDeclaration", "vs/editor/contrib/hover/common/hover", "vs/editor/contrib/wordHighlighter/common/wordHighlighter", "vs/editor/contrib/referenceSearch/browser/referenceSearch", "vs/editor/contrib/quickFix/browser/quickFix", "vs/workbench/parts/search/common/search", "vs/editor/contrib/rename/browser/rename", "vs/editor/contrib/parameterHints/common/parameterHints", "vs/editor/contrib/suggest/browser/suggest", "vs/editor/contrib/format/common/format", "vs/editor/contrib/links/common/links", "vs/base/common/async", "vs/workbench/api/node/extHost.protocol", "vs/workbench/api/node/extHostDiagnostics", "vs/workbench/api/node/extHostHeapService"], function (require, exports, assert, instantiationServiceMock_1, errors_1, uri_1, types, EditorCommon, model_1, position_1, range_1, testThreadService_1, markers_1, markerService_1, extHostLanguageFeatures_1, mainThreadLanguageFeatures_1, extHostCommands_1, mainThreadCommands_1, mainThreadHeapService_1, extHostDocuments_1, extHostDocumentsAndEditors_1, quickOpen_1, modes_1, codelens_1, goToDeclaration_1, hover_1, wordHighlighter_1, referenceSearch_1, quickFix_1, search_1, rename_1, parameterHints_1, suggest_1, format_1, links_1, async_1, extHost_protocol_1, extHostDiagnostics_1, extHostHeapService_1) {
    'use strict';
    ...
    suite('ExtHostLanguageFeatures', function () {
        suiteSetup(function () {
            ...
            var commands = new extHostCommands_1.ExtHostCommands(threadService, heapService);
        ...
        test('HoverProvider, word range at pos', function () {
            ...
            return threadService.sync().then(function () {
                hover_1.getHover(model, new position_1.Position(1, 1)).then(function (value) {
                    assert.equal(value.length, 1);
                    var entry = value[0];
        ...
        test('HoverProvider, registration order', function () {
            ...
            return threadService.sync().then(function () {
                return hover_1.getHover(model, new position_1.Position(1, 1)).then(function (value) {
                    assert.equal(value.length, 2);
        ...
        test('Parameter Hints, order', function () {
            ...
            return threadService.sync().then(function () {
                return parameterHints_1.provideSignatureHelp(model, new position_1.Position(1, 1)).then(function (value) {
                    assert.ok(value);
                });
            });
        });
        ...
        test('Links, data conversion', function () {
            ...
            return threadService.sync().then(function () {
                return links_1.getLinks(model).then(function (value) {
                    assert.equal(value.length, 1);
                    var first = value[0];
