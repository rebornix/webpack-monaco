...
define(["require", "exports", "assert", "vs/base/common/uri", "vs/base/common/severity", "vs/workbench/api/node/extHostDiagnostics", "vs/workbench/api/node/extHostTypes", "vs/base/common/winjs.base", "vs/workbench/test/electron-browser/api/mock"], function (require, exports, assert, uri_1, severity_1, extHostDiagnostics_1, extHostTypes_1, winjs_base_1, mock_1) {
    'use strict';
    Object.defineProperty(exports, "__esModule", { value: true });
    suite('ExtHostDiagnostics', function () {
        var DiagnosticsShape = (function (_super) {
        ...
        test('diagnostics collection, set tuple overrides, #11547', function () {
            var lastEntries;
            var collection = new extHostDiagnostics_1.DiagnosticCollection('test', new (function (_super) {
