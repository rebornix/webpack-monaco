 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/base/common/uri", "vs/workbench/test/workbenchTestServices", "vs/editor/common/services/modelService", "vs/editor/common/services/modeService", "vs/editor/common/services/modeServiceImpl", "vs/workbench/services/editor/common/editorService", "vs/workbench/common/editor/rangeDecorations", "vs/editor/common/model/model", "vs/editor/test/common/mocks/mockCodeEditor", "vs/workbench/parts/files/common/editors/fileEditorInput", "vs/editor/common/model/textModel", "vs/editor/common/core/range", "vs/editor/common/core/position", "vs/platform/configuration/common/configuration", "vs/platform/configuration/test/common/testConfigurationService", "vs/editor/common/services/modelServiceImpl", "vs/editor/common/controller/coreCommands"], function (require, exports, assert, uri_1, workbenchTestServices_1, modelService_1, modeService_1, modeServiceImpl_1, WorkbenchEditorService, rangeDecorations_1, model_1, mockCodeEditor_1, fileEditorInput_1, textModel_1, range_1, position_1, configuration_1, testConfigurationService_1, modelServiceImpl_1, coreCommands_1) {
    "use strict";
    ...
    suite('Editor - Range decorations', function () {
        ...
        setup(function () {
            ...
            editorService = instantiationService.stub(WorkbenchEditorService.IWorkbenchEditorService, new workbenchTestServices_1.TestEditorService());
            modeService = instantiationService.stub(modeService_1.IModeService, modeServiceImpl_1.ModeServiceImpl);
            modelService = instantiationService.stub(modelService_1.IModelService, stubModelService(instantiationService));
            text = 'LINE1' + '\n' + 'LINE2' + '\n' + 'LINE3' + '\n' + 'LINE4' + '\r\n' + 'LINE5';
            model = aModel(uri_1.default.file('some_file'));
            codeEditor = mockCodeEditor_1.mockCodeEditor([], { model: model });
        ...
        function aModel(resource, content) {
            ...
            var model = model_1.Model.createFromString(content, textModel_1.TextModel.DEFAULT_CREATION_OPTIONS, null, resource);
