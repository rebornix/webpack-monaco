...
define(["require", "exports", "vs/base/common/winjs.base", "vs/nls", "vs/base/browser/browser", "vs/base/browser/builder", "vs/base/common/strings", "vs/base/common/filters", "vs/base/browser/dom", "vs/base/common/idGenerator", "vs/base/common/types", "vs/base/common/actions", "vs/base/common/cancellation", "vs/base/parts/quickopen/common/quickOpen", "vs/base/parts/quickopen/browser/quickOpenModel", "vs/base/parts/quickopen/browser/quickOpenWidget", "vs/workbench/browser/actions", "vs/base/common/labels", "vs/base/common/paths", "vs/workbench/services/textfile/common/textfiles", "vs/platform/registry/common/platform", "vs/editor/common/services/modeService", "vs/workbench/browser/labels", "vs/editor/common/services/modelService", "vs/workbench/common/editor", "vs/workbench/common/component", "vs/base/common/event", "vs/workbench/services/part/common/partService", "vs/workbench/browser/quickopen", "vs/base/common/errors", "vs/workbench/services/editor/common/editorService", "vs/platform/quickOpen/common/quickOpen", "vs/platform/configuration/common/configuration", "vs/platform/instantiation/common/instantiation", "vs/platform/message/common/message", "vs/platform/telemetry/common/telemetry", "vs/platform/workspace/common/workspace", "vs/platform/contextkey/common/contextkey", "vs/workbench/services/history/common/history", "vs/platform/list/browser/listService", "vs/platform/theme/common/themeService", "vs/workbench/common/theme", "vs/platform/theme/common/styler", "vs/platform/environment/common/environment", "vs/css!./media/quickopen"], function (require, exports, winjs_base_1, nls, browser, builder_1, strings, filters, DOM, idGenerator_1, types, actions_1, cancellation_1, quickOpen_1, quickOpenModel_1, quickOpenWidget_1, actions_2, labels, paths, textfiles_1, platform_1, modeService_1, labels_1, modelService_1, editor_1, component_1, event_1, partService_1, quickopen_1, errors, editorService_1, quickOpen_2, configuration_1, instantiation_1, message_1, telemetry_1, workspace_1, contextkey_1, history_1, listService_1, themeService_1, theme_1, styler_1, environment_1) {
    'use strict';
    Object.defineProperty(exports, "__esModule", { value: true });
    var HELP_PREFIX = '?';
    var QuickOpenController = (function (_super) {
        __extends(QuickOpenController, _super);
        function QuickOpenController(editorService, messageService, telemetryService, contextService, contextKeyService, configurationService, historyService, instantiationService, partService, listService, themeService) {
        ...
        QuickOpenController.prototype.registerListeners = function () {
            var _this = this;
            this.toUnbind.push(this.configurationService.onDidUpdateConfiguration(function (e) { return _this.updateConfiguration(_this.configurationService.getConfiguration()); }));
        ...
        QuickOpenController.prototype.show = function (prefix, options) {
            ...
            if (!this.quickOpenWidget.isVisible() || quickNavigateConfiguration) {
                if (prefix) {
                    this.quickOpenWidget.show(prefix, { quickNavigateConfiguration: quickNavigateConfiguration, inputSelection: inputSelection });
                }
                else {
        ...
        QuickOpenController.prototype.resolveHandler = function (handler) {
            ...
            return result.then(null, function (error) {
                ...
                return winjs_base_1.TPromise.wrapError(new Error('Unable to instantiate quick open handler ' + handler.moduleName + ' - ' + handler.ctorName + ': ' + JSON.stringify(error)));
            });
        };
    ...
    var PickOpenActionProvider = (function () {
    ...
    var EditorHistoryEntry = (function (_super) {
        ...
        function EditorHistoryEntry(input, editorService, modeService, modelService, textFileService, contextService, configurationService, environmentService) {
            ...
            if (input instanceof editor_1.EditorInput) {
                ...
                _this.description = labels.getPathLabel(paths.dirname(_this.resource.fsPath), contextService, environmentService);
