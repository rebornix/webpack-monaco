...
define(["require", "exports", "vs/nls", "vs/base/common/objects", "vs/base/common/types", "vs/base/common/errors", "vs/base/browser/dom", "vs/editor/browser/codeEditor", "vs/workbench/common/editor", "vs/workbench/browser/parts/editor/baseEditor", "vs/editor/common/editorCommon", "vs/platform/storage/common/storage", "vs/platform/instantiation/common/instantiation", "vs/platform/telemetry/common/telemetry", "vs/platform/theme/common/themeService", "vs/workbench/common/memento", "vs/editor/common/services/codeEditorService", "vs/editor/common/services/modeService", "vs/workbench/services/textfile/common/textfiles", "vs/editor/common/services/resourceConfiguration", "vs/workbench/services/group/common/groupService"], function (require, exports, nls, objects, types, errors, DOM, codeEditor_1, editor_1, baseEditor_1, editorCommon_1, storage_1, instantiation_1, telemetry_1, themeService_1, memento_1, codeEditorService_1, modeService_1, textfiles_1, resourceConfiguration_1, groupService_1) {
    'use strict';
    ...
    var BaseTextEditor = (function (_super) {
        ...
        function BaseTextEditor(id, telemetryService, _instantiationService, storageService, _configurationService, themeService, modeService, _textFileService, editorGroupService) {
            ...
            _this.toUnbind.push(_this.configurationService.onDidUpdateConfiguration(function (e) { return _this.handleConfigurationChangeEvent(_this.configurationService.getConfiguration(_this.getResource())); }));
            return _this;
        }
        ...
        BaseTextEditor.prototype.createEditor = function (parent) {
            ...
            this.editorControl = this.createEditorControl(parent, this.computeConfiguration(this.configurationService.getConfiguration(this.getResource())));
            ...
            if (editorCommon_1.isCommonCodeEditor(this.editorControl)) {
                this.toUnbind.push(this.editorControl.onDidBlurEditor(function () { return _this.onEditorFocusLost(); }));
            }
            else if (editorCommon_1.isCommonDiffEditor(this.editorControl)) {
        ...
        BaseTextEditor.prototype.saveTextEditorViewState = function (key) {
            ...
            var lastKnownViewState = textEditorViewStateMemento[key];
        ...
        BaseTextEditor.prototype.loadTextEditorViewState = function (key) {
            ...
            var textEditorViewStateMemento = memento[TEXT_EDITOR_VIEW_STATE_PREFERENCE_KEY];
            if (textEditorViewStateMemento) {
                var viewState = textEditorViewStateMemento[key];
                if (viewState) {
        ...
        BaseTextEditor.prototype.updateEditorConfiguration = function (configuration) {
            if (configuration === void 0) { configuration = this.configurationService.getConfiguration(this.getResource()); }
            if (!this.editorControl) {
                return;
            }
        ...
        BaseTextEditor.prototype.getResource = function () {
            ...
            if (this.input) {
                return editor_1.toResource(this.input);
            }
            return null;
        };
