...
define(["require", "exports", "vs/base/common/winjs.base", "vs/nls", "vs/base/common/actions", "vs/base/common/objects", "vs/editor/common/services/codeEditorService", "vs/workbench/common/editor", "vs/base/parts/quickopen/browser/quickOpenModel", "vs/workbench/browser/quickopen", "vs/workbench/services/editor/common/editorService", "vs/platform/quickOpen/common/quickOpen", "vs/workbench/services/part/common/partService", "vs/platform/editor/common/editor", "vs/workbench/services/history/common/history", "vs/platform/keybinding/common/keybinding", "vs/workbench/services/group/common/groupService", "vs/platform/commands/common/commands", "vs/workbench/services/textfile/common/textfiles", "vs/platform/windows/common/windows"], function (require, exports, winjs_base_1, nls, actions_1, objects_1, codeEditorService_1, editor_1, quickOpenModel_1, quickopen_1, editorService_1, quickOpen_1, partService_1, editor_2, history_1, keybinding_1, groupService_1, commands_1, textfiles_1, windows_1) {
    ...
    var JoinTwoGroupsAction = (function (_super) {
        __extends(JoinTwoGroupsAction, _super);
        function JoinTwoGroupsAction(id, label, editorService, editorGroupService) {
    ...
    var CloseRightEditorsInGroupAction = (function (_super) {
        ...
        CloseRightEditorsInGroupAction.prototype.run = function (context) {
            var editor = getTarget(this.editorService, this.groupService, context);
            if (editor) {
                return this.editorService.closeEditors(editor.position, { except: editor.input, direction: editor_2.Direction.RIGHT });
            }
            return winjs_base_1.TPromise.as(false);
        };
    ...
    var CloseUnmodifiedEditorsInGroupAction = (function (_super) {
        __extends(CloseUnmodifiedEditorsInGroupAction, _super);
        function CloseUnmodifiedEditorsInGroupAction(id, label, editorGroupService, editorService) {
            var _this = _super.call(this, id, label) || this;
            _this.editorGroupService = editorGroupService;
            _this.editorService = editorService;
            return _this;
        }
        CloseUnmodifiedEditorsInGroupAction.prototype.run = function (context) {
            var position = context ? this.editorGroupService.getStacksModel().positionOfGroup(context.group) : null;
        ...
        CloseUnmodifiedEditorsInGroupAction.ID = 'workbench.action.closeUnmodifiedEditors';
        CloseUnmodifiedEditorsInGroupAction.LABEL = nls.localize('closeUnmodifiedEditors', "Close Unmodified Editors in Group");
        CloseUnmodifiedEditorsInGroupAction = __decorate([
            __param(2, groupService_1.IEditorGroupService),
            __param(3, editorService_1.IWorkbenchEditorService)
        ], CloseUnmodifiedEditorsInGroupAction);
        return CloseUnmodifiedEditorsInGroupAction;
    }(actions_1.Action));
    exports.CloseUnmodifiedEditorsInGroupAction = CloseUnmodifiedEditorsInGroupAction;
    ...
    var ClearRecentFilesAction = (function (_super) {
    ...
    var OpenNextRecentlyUsedEditorAction = (function (_super) {
    ...
    var OpenPreviousRecentlyUsedEditorAction = (function (_super) {
