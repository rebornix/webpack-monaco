    ...
    var BaseBinaryResourceEditor = (function (_super) {
        ...
        BaseBinaryResourceEditor.prototype.setInput = function (input, options) {
            ...
            return input.resolve(true).then(function (resolvedModel) {
                ...
                resourceViewer_1.ResourceViewer.show({ name: model.getName(), resource: model.getResource(), size: model.getSize(), etag: model.getETag() }, _this.binaryContainer, _this.scrollbar, function (resource) {
