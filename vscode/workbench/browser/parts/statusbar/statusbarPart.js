...
define(["require", "exports", "vs/base/browser/dom", "vs/nls", "vs/base/common/errorMessage", "vs/base/common/winjs.base", "vs/base/common/lifecycle", "vs/base/browser/builder", "vs/base/browser/ui/octiconLabel/octiconLabel", "vs/platform/registry/common/platform", "vs/platform/commands/common/commands", "vs/workbench/services/editor/common/editorService", "vs/workbench/browser/part", "vs/workbench/common/actionRegistry", "vs/workbench/browser/parts/statusbar/statusbar", "vs/platform/instantiation/common/instantiation", "vs/platform/telemetry/common/telemetry", "vs/platform/message/common/message", "vs/editor/common/services/codeEditorService", "vs/platform/contextview/browser/contextView", "vs/base/common/actions", "vs/platform/theme/common/themeService", "vs/workbench/common/theme", "vs/platform/workspace/common/workspace", "vs/platform/theme/common/colorRegistry", "vs/editor/common/editorCommon", "vs/base/common/color", "vs/css!./media/statusbarpart"], function (require, exports, dom, nls, errorMessage_1, winjs_base_1, lifecycle_1, builder_1, octiconLabel_1, platform_1, commands_1, editorService_1, part_1, actionRegistry_1, statusbar_1, instantiation_1, telemetry_1, message_1, codeEditorService_1, contextView_1, actions_1, themeService_1, theme_1, workspace_1, colorRegistry_1, editorCommon_1, color_1) {
    ...
    var StatusbarPart = (function (_super) {
        ...
        StatusbarPart.prototype.updateStyles = function () {
            ...
            container.style('color', this.getColor(this.contextService.hasWorkspace() ? theme_1.STATUS_BAR_FOREGROUND : theme_1.STATUS_BAR_NO_FOLDER_FOREGROUND));
            container.style('background-color', this.getColor(this.contextService.hasWorkspace() ? theme_1.STATUS_BAR_BACKGROUND : theme_1.STATUS_BAR_NO_FOLDER_BACKGROUND));
            var borderColor = this.getColor(this.contextService.hasWorkspace() ? theme_1.STATUS_BAR_BORDER : theme_1.STATUS_BAR_NO_FOLDER_BORDER) || this.getColor(colorRegistry_1.contrastBorder);
