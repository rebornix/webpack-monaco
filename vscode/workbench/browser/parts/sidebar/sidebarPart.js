...
define(["require", "exports", "vs/base/common/winjs.base", "vs/nls", "vs/platform/registry/common/platform", "vs/base/common/actions", "vs/workbench/browser/parts/compositePart", "vs/workbench/browser/viewlet", "vs/workbench/common/actionRegistry", "vs/platform/actions/common/actions", "vs/base/browser/ui/actionbar/actionbar", "vs/workbench/services/viewlet/browser/viewlet", "vs/workbench/services/part/common/partService", "vs/workbench/browser/actions", "vs/platform/storage/common/storage", "vs/platform/contextview/browser/contextView", "vs/platform/message/common/message", "vs/platform/telemetry/common/telemetry", "vs/platform/keybinding/common/keybinding", "vs/platform/instantiation/common/instantiation", "vs/platform/theme/common/themeService", "vs/platform/theme/common/colorRegistry", "vs/workbench/common/theme", "vs/workbench/browser/actions/toggleSidebarVisibility", "vs/css!./media/sidebarpart"], function (require, exports, winjs_base_1, nls, platform_1, actions_1, compositePart_1, viewlet_1, actionRegistry_1, actions_2, actionbar_1, viewlet_2, partService_1, actions_3, storage_1, contextView_1, message_1, telemetry_1, keybinding_1, instantiation_1, themeService_1, colorRegistry_1, theme_1, toggleSidebarVisibility_1) {
    ...
    var SidebarPart = (function (_super) {
        ...
        function SidebarPart(id, messageService, storageService, telemetryService, contextMenuService, partService, keybindingService, instantiationService, themeService) {
            var _this = _super.call(this, messageService, storageService, telemetryService, contextMenuService, partService, keybindingService, instantiationService, themeService, platform_1.Registry.as(viewlet_1.Extensions.Viewlets), SidebarPart.activeViewletSettingsKey, platform_1.Registry.as(viewlet_1.Extensions.Viewlets).getDefaultViewletId(), 'sideBar', 'viewlet', actions_3.Scope.VIEWLET, theme_1.SIDE_BAR_TITLE_FOREGROUND, id, { hasTitle: true, borderWidth: function () { return (_this.getColor(theme_1.SIDE_BAR_BORDER) || _this.getColor(colorRegistry_1.contrastBorder)) ? 1 : 0; } }) || this;
            return _this;
        }
