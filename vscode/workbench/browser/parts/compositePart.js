...
define(["require", "exports", "vs/nls", "vs/base/common/idGenerator", "vs/base/common/winjs.base", "vs/platform/registry/common/platform", "vs/base/common/lifecycle", "vs/base/browser/builder", "vs/base/common/events", "vs/base/common/strings", "vs/base/common/event", "vs/base/common/types", "vs/base/common/errors", "vs/base/browser/dom", "vs/base/browser/mouseEvent", "vs/base/browser/ui/toolbar/toolbar", "vs/base/browser/ui/actionbar/actionbar", "vs/base/browser/ui/progressbar/progressbar", "vs/workbench/browser/actions", "vs/workbench/browser/part", "vs/workbench/services/progress/browser/progressService", "vs/platform/storage/common/storage", "vs/platform/instantiation/common/serviceCollection", "vs/platform/message/common/message", "vs/platform/progress/common/progress", "vs/platform/theme/common/styler", "vs/css!./media/compositepart"], function (require, exports, nls, idGenerator_1, winjs_base_1, platform_1, lifecycle_1, builder_1, events, strings, event_1, types, errors, DOM, mouseEvent_1, toolbar_1, actionbar_1, progressbar_1, actions_1, part_1, progressService_1, storage_1, serviceCollection_1, message_1, progress_1, styler_1) {
    'use strict';
    Object.defineProperty(exports, "__esModule", { value: true });
    var CompositePart = (function (_super) {
        __extends(CompositePart, _super);
        function CompositePart(messageService, storageService, telemetryService, contextMenuService, partService, keybindingService, instantiationService, themeService, registry, activeCompositeSettingsKey, defaultCompositeId, nameForTelemetry, compositeCSSClass, actionContributionScope, titleForegroundColor, id, options) {
        ...
        CompositePart.prototype.showComposite = function (composite) {
            ...
            return createCompositePromise.then(function () {
                ...
                // Action Run Handling
                _this.telemetryActionsListener = _this.toolBar.actionRunner.addListener(events.EventType.RUN, function (e) {
                    // Check for Error
