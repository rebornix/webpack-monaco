...
define(["require", "exports", "vs/nls", "vs/base/common/lifecycle", "vs/base/common/winjs.base", "vs/base/common/scrollable", "vs/base/browser/dom", "vs/base/parts/tree/browser/treeImpl", "vs/base/parts/tree/browser/treeDefaults", "vs/editor/common/core/range", "vs/editor/browser/editorBrowser", "vs/workbench/parts/debug/common/debugModel", "vs/workbench/parts/debug/electron-browser/debugViewer", "vs/base/browser/ui/scrollbar/scrollableElement", "vs/platform/theme/common/styler", "vs/platform/theme/common/colorRegistry"], function (require, exports, nls, lifecycle, winjs_base_1, scrollable_1, dom, treeImpl_1, treeDefaults_1, range_1, editorBrowser_1, debugModel_1, debugViewer_1, scrollableElement_1, styler_1, colorRegistry_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var $ = dom.$;
    var MAX_ELEMENTS_SHOWN = 18;
    var DebugHoverWidget = (function () {
        function DebugHoverWidget(editor, debugService, listService, instantiationService, themeService) {
            this.editor = editor;
        ...
        DebugHoverWidget.prototype.registerListeners = function () {
            var _this = this;
            this.toDispose.push(this.tree.addListener('item:expanded', function () {
                _this.layoutTree();
            }));
            this.toDispose.push(this.tree.addListener('item:collapsed', function () {
                _this.layoutTree();
            }));
