...
define(["require", "exports", "vs/nls", "vs/base/common/errors", "vs/base/common/winjs.base", "vs/base/common/async", "vs/base/common/lifecycle", "vs/base/common/platform", "vs/base/common/json", "vs/base/common/actions", "vs/editor/common/model/wordHelper", "vs/editor/browser/editorBrowser", "vs/editor/browser/editorBrowserExtensions", "vs/editor/common/editorCommon", "vs/editor/common/services/codeEditorService", "vs/editor/common/core/range", "vs/platform/instantiation/common/instantiation", "vs/platform/telemetry/common/telemetry", "vs/platform/configuration/common/configuration", "vs/platform/commands/common/commands", "vs/platform/contextkey/common/contextkey", "vs/platform/contextview/browser/contextView", "vs/workbench/parts/debug/electron-browser/debugHover", "vs/workbench/parts/debug/browser/debugActions", "vs/workbench/parts/debug/common/debug", "vs/workbench/parts/debug/browser/breakpointWidget", "vs/workbench/parts/debug/browser/exceptionWidget", "vs/workbench/parts/preferences/browser/preferencesWidgets", "vs/platform/list/browser/listService", "vs/platform/theme/common/themeService", "vs/editor/common/core/position", "vs/editor/common/controller/coreCommands", "vs/base/common/arrays"], function (require, exports, nls, errors, winjs_base_1, async_1, lifecycle, env, json_1, actions_1, wordHelper_1, editorBrowser_1, editorBrowserExtensions_1, editorCommon_1, codeEditorService_1, range_1, instantiation_1, telemetry_1, configuration_1, commands_1, contextkey_1, contextView_1, debugHover_1, debugActions_1, debug_1, breakpointWidget_1, exceptionWidget_1, preferencesWidgets_1, listService_1, themeService_1, position_1, coreCommands_1, arrays_1) {
    "use strict";
    ...
    var DebugEditorContribution = (function () {
        function DebugEditorContribution(editor, debugService, contextMenuService, instantiationService, contextKeyService, commandService, codeEditorService, telemetryService, listService, configurationService, themeService) {
            var _this = this;
            this.editor = editor;
            ...
            this.hoverWidget = new debugHover_1.DebugHoverWidget(this.editor, this.debugService, listService, this.instantiationService, themeService);
            this.toDispose = [];
        ...
        DebugEditorContribution_1 = DebugEditorContribution;
        DebugEditorContribution.prototype.getContextMenuActions = function (breakpoints, uri, lineNumber) {
            ...
            if (breakpoints.length === 1) {
                ...
                actions.push(this.instantiationService.createInstance(debugActions_1.EditConditionalBreakpointAction, debugActions_1.EditConditionalBreakpointAction.ID, debugActions_1.EditConditionalBreakpointAction.LABEL, this.editor));
        ...
        DebugEditorContribution.prototype.registerListeners = function () {
            ...
            this.toDispose.push(this.editor.onMouseDown(function (e) {
                if (e.target.type !== editorBrowser_1.MouseTargetType.GUTTER_GLYPH_MARGIN || e.target.detail || !_this.marginFreeFromNonDebugDecorations(e.target.position.lineNumber)) {
                    return;
                }
        ...
        DebugEditorContribution.prototype.showExceptionWidget = function (exceptionInfo, lineNumber, column) {
            ...
            this.exceptionWidget = this.instantiationService.createInstance(exceptionWidget_1.ExceptionWidget, this.editor, exceptionInfo, lineNumber);
                    ...
                    for (var token = lineTokens.firstToken(); !!token; token = token.next()) {
                        ...
                        if (token.tokenType === 0 /* Other */) {
                            ...
                            if (wordMatch) {
                                ...
                                this.wordToLineNumbersMap.get(word).push(new position_1.Position(lineNumber, token.startOffset));
                            }
                        }
                    }
                }
