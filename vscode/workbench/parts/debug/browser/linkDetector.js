...
define(["require", "exports", "vs/base/common/strings", "vs/base/common/uri", "vs/base/common/platform", "vs/base/common/errors", "vs/base/browser/mouseEvent", "vs/nls", "vs/workbench/services/editor/common/editorService", "vs/platform/workspace/common/workspace"], function (require, exports, strings, uri_1, platform_1, errors, mouseEvent_1, nls, editorService_1, workspace_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var LinkDetector = (function () {
        function LinkDetector(editorService, contextService) {
                ...
                var _loop_1 = function () {
                    ...
                    try {
                        resource = (match && !strings.startsWith(match[0], 'http'))
                            && (match[2] || strings.startsWith(match[1], '/') ? uri_1.default.file(match[1]) : this_1.contextService.toResource(match[1])); // TODO@Michel TODO@Isidor (https://github.com/Microsoft/vscode/issues/29190)
                    }
                    catch (e) { }
                    if (!resource) {
