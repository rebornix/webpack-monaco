...
define(["require", "exports", "vs/base/common/errors", "vs/base/common/strings", "vs/base/browser/browser", "vs/base/common/severity", "vs/base/browser/builder", "vs/base/browser/dom", "vs/base/common/arrays", "vs/base/browser/mouseEvent", "vs/base/common/events", "vs/base/browser/ui/actionbar/actionbar", "vs/workbench/services/part/common/partService", "vs/workbench/parts/debug/common/debug", "vs/workbench/parts/debug/browser/debugActions", "vs/workbench/parts/debug/browser/debugActionItems", "vs/platform/instantiation/common/instantiation", "vs/platform/configuration/common/configuration", "vs/platform/storage/common/storage", "vs/platform/message/common/message", "vs/platform/telemetry/common/telemetry", "vs/workbench/common/theme", "vs/platform/theme/common/themeService", "vs/platform/theme/common/colorRegistry", "vs/nls", "vs/css!vs/workbench/parts/debug/browser/media/debugActionsWidget"], function (require, exports, errors, strings, browser, severity_1, builder, dom, arrays, mouseEvent_1, events_1, actionbar_1, partService_1, debug_1, debugActions_1, debugActionItems_1, instantiation_1, configuration_1, storage_1, message_1, telemetry_1, theme_1, themeService_1, colorRegistry_1, nls_1) {
    ...
    var DebugActionsWidget = (function (_super) {
        __extends(DebugActionsWidget, _super);
        function DebugActionsWidget(messageService, telemetryService, debugService, instantiationService, partService, storageService, configurationService, themeService) {
            ...
            _this.actionBar = new actionbar_1.ActionBar(actionBarContainter, {
                ...
                actionItemProvider: function (action) {
                    if (action.id === debugActions_1.FocusProcessAction.ID) {
                        return _this.instantiationService.createInstance(debugActionItems_1.FocusProcessActionItem, action);
                    }
                    return null;
                }
            });
        ...
        DebugActionsWidget.prototype.registerListeners = function () {
            ...
            this.toUnbind.push(this.configurationService.onDidUpdateConfiguration(function () { return _this.update(_this.debugService.state); }));
            this.toUnbind.push(this.actionBar.actionRunner.addListener(events_1.EventType.RUN, function (e) {
                // check for error
        ...
        DebugActionsWidget.prototype.storePosition = function () {
            ...
            this.telemetryService.publicLog(DEBUG_ACTIONS_WIDGET_POSITION_KEY, { position: position });
        };
        ...
        DebugActionsWidget.prototype.update = function (state) {
            if (state === debug_1.State.Inactive || this.configurationService.getConfiguration('debug').hideActionBar) {
                return this.hide();
            }
