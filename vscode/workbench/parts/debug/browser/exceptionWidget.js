...
define(["require", "exports", "vs/nls", "vs/base/browser/dom", "vs/editor/contrib/zoneWidget/browser/zoneWidget", "vs/platform/contextview/browser/contextView", "vs/workbench/parts/debug/common/debug", "vs/base/common/async", "vs/platform/theme/common/themeService", "vs/base/common/color", "vs/platform/theme/common/colorRegistry", "vs/platform/instantiation/common/instantiation", "vs/workbench/parts/debug/browser/linkDetector", "vs/css!../browser/media/exceptionWidget"], function (require, exports, nls, dom, zoneWidget_1, contextView_1, debug_1, async_1, themeService_1, color_1, colorRegistry_1, instantiation_1, linkDetector_1) {
    "use strict";
    ...
    exports.debugExceptionWidgetBackground = colorRegistry_1.registerColor('debugExceptionWidget.background', { dark: '#a3151540', light: '#a315150d', hc: '#a3151573' }, nls.localize('debugExceptionWidgetBackground', 'Exception widget background color.'));
    var ExceptionWidget = (function (_super) {
        __extends(ExceptionWidget, _super);
        function ExceptionWidget(editor, exceptionInfo, lineNumber, contextViewService, debugService, themeService, instantiationService) {
