...
define(["require", "exports", "fs", "path", "vs/nls", "vs/base/common/winjs.base", "vs/base/common/strings", "vs/base/common/objects", "vs/base/common/paths", "vs/base/common/platform", "vs/workbench/parts/debug/common/debug", "vs/workbench/services/configurationResolver/common/configurationResolver", "vs/platform/configuration/common/configuration", "vs/platform/commands/common/commands"], function (require, exports, fs, path, nls, winjs_base_1, strings, objects, paths, platform, debug_1, configurationResolver_1, configuration_1, commands_1) {
    "use strict";
    ...
    var Adapter = (function () {
        ...
        Adapter.prototype.getAdapterExecutable = function (root, verifyAgainstFS) {
            ...
            if (this.rawAdapter.adapterExecutableCommand) {
                return this.commandService.executeCommand(this.rawAdapter.adapterExecutableCommand, root.toString()).then(function (ad) {
                    return _this.verifyAdapterDetails(ad, verifyAgainstFS);
                });
            }
            var adapterExecutable = {
                command: this.getProgram(),
                args: this.getAttributeBasedOnPlatform('args')
            };
            var runtime = this.getRuntime();
            if (runtime) {
                var runtimeArgs = this.getAttributeBasedOnPlatform('runtimeArgs');
        ...
        Adapter.prototype.verifyAdapterDetails = function (details, verifyAgainstFS) {
            ...
            return winjs_base_1.TPromise.wrapError(new Error(nls.localize({ key: 'debugAdapterCannotDetermineExecutable', comment: ['Adapter executable file not found'] }, "Cannot determine executable for debug adapter '{0}'.", details.command)));
        };
        ...
        Object.defineProperty(Adapter.prototype, "startSessionCommand", {
            get: function () {
        ...
        Adapter.prototype.getInitialConfigurationContent = function (folderUri, initialConfigs) {
            ...
            if (typeof this.rawAdapter.initialConfigurations === 'string') {
                ...
                return this.commandService.executeCommand(this.rawAdapter.initialConfigurations, folderUri).then(function (content) {
