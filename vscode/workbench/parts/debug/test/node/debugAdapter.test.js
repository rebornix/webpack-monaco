 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/base/common/paths", "vs/base/common/platform", "vs/workbench/parts/debug/node/debugAdapter", "vs/platform/configuration/test/common/testConfigurationService"], function (require, exports, assert, paths, platform, debugAdapter_1, testConfigurationService_1) {
    "use strict";
    ...
    suite('Debug - Adapter', function () {
        ...
        setup(function () {
            adapter = new debugAdapter_1.Adapter(rawAdapter, { extensionFolderPath: extensionFolderPath, id: 'adapter', name: 'myAdapter', version: '1.0.0', publisher: 'vscode', isBuiltin: false, engines: null }, null, new testConfigurationService_1.TestConfigurationService(), null);
        });
        teardown(function () {
            adapter = null;
        });
        ...
        test('initial config file content', function () {
            var expected = ['{',
                ...
                '	]',
                '}'].join('\n');
            return adapter.getInitialConfigurationContent(null).then(function (content) {
