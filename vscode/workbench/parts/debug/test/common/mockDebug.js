...
define(["require", "exports", "vs/base/common/event", "vs/base/common/winjs.base"], function (require, exports, event_1, winjs_base_1) {
    ...
    var MockDebugService = (function () {
        ...
        MockDebugService.prototype.focusStackFrameAndEvaluate = function (focusedStackFrame) {
        ...
        MockDebugService.prototype.startDebugging = function (root, configOrName, noDebug) {
            return winjs_base_1.TPromise.as(null);
        };
        MockDebugService.prototype.createProcess = function (root, config) {
            return winjs_base_1.TPromise.as(null);
        };
        MockDebugService.prototype.findProcessByUUID = function (uuid) {
            return null;
        };
