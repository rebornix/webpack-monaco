...
define(["require", "exports", "vs/nls", "vs/base/common/winjs.base", "vs/base/common/async", "vs/base/browser/dom", "vs/base/common/platform", "vs/base/browser/ui/checkbox/checkbox", "vs/base/browser/ui/highlightedlabel/highlightedLabel", "vs/base/browser/ui/keybindingLabel/keybindingLabel", "vs/base/browser/ui/actionbar/actionbar", "vs/workbench/browser/parts/editor/baseEditor", "vs/workbench/common/editor", "vs/platform/telemetry/common/telemetry", "vs/platform/clipboard/common/clipboardService", "vs/workbench/parts/preferences/common/keybindingsEditorModel", "vs/platform/instantiation/common/instantiation", "vs/platform/keybinding/common/keybinding", "vs/workbench/parts/preferences/browser/preferencesWidgets", "vs/workbench/parts/preferences/browser/keybindingWidgets", "vs/workbench/parts/preferences/common/preferences", "vs/platform/contextview/browser/contextView", "vs/workbench/services/keybinding/common/keybindingEditing", "vs/platform/list/browser/listService", "vs/base/browser/ui/list/listWidget", "vs/platform/theme/common/themeService", "vs/platform/contextkey/common/contextkey", "vs/platform/message/common/message", "vs/base/browser/keyboardEvent", "vs/platform/theme/common/styler", "vs/platform/theme/common/colorRegistry", "vs/workbench/services/editor/common/editorService", "vs/css!./media/keybindingsEditor"], function (require, exports, nls_1, winjs_base_1, async_1, DOM, platform_1, checkbox_1, highlightedLabel_1, keybindingLabel_1, actionbar_1, baseEditor_1, editor_1, telemetry_1, clipboardService_1, keybindingsEditorModel_1, instantiation_1, keybinding_1, preferencesWidgets_1, keybindingWidgets_1, preferences_1, contextView_1, keybindingEditing_1, listService_1, listWidget_1, themeService_1, contextkey_1, message_1, keyboardEvent_1, styler_1, colorRegistry_1, editorService_1) {
    ...
    var KeybindingsEditor = (function (_super) {
        __extends(KeybindingsEditor, _super);
        function KeybindingsEditor(telemetryService, themeService, keybindingsService, contextMenuService, preferencesService, keybindingEditingService, listService, contextKeyService, choiceService, messageService, clipboardService, instantiationService, editorService) {
        ...
        KeybindingsEditor.prototype.createEditor = function (parent) {
            ...
            this._register(focusTracker.addFocusListener(function () { return _this.keybindingsEditorContextKey.set(true); }));
            this._register(focusTracker.addBlurListener(function () { return _this.keybindingsEditorContextKey.reset(); }));
        };
        KeybindingsEditor.prototype.setInput = function (input) {
            var _this = this;
        ...
        KeybindingsEditor.prototype.showConflicts = function (keybindingEntry) {
        ...
        KeybindingsEditor.prototype.createList = function (parent) {
            ...
            this.keybindingsList = this._register(new listWidget_1.List(this.keybindingsListContainer, new Delegate(), [new KeybindingHeaderRenderer(), new KeybindingItemRenderer(this, this.keybindingsService)], { identityProvider: function (e) { return e.id; }, keyboardSupport: false, mouseSupport: true, ariaLabel: nls_1.localize('keybindingsLabel', "Keybindings") }));
            ...
            this._register(this.keybindingsList.onDOMFocus(function () {
                DOM.addClass(_this.keybindingsList.getHTMLElement(), 'focused');
            }));
            this._register(this.keybindingsList.onDOMBlur(function () {
                DOM.removeClass(_this.keybindingsList.getHTMLElement(), 'focused');
                _this.keybindingFocusContextKey.reset();
            }));
            this._register(styler_1.attachListStyler(this.keybindingsList, this.themeService));
            this._register(this.listService.register(this.keybindingsList));
        };
        KeybindingsEditor.prototype.render = function () {
            var _this = this;
            if (this.input) {
                return this.input.resolve()
                    .then(function (keybindingsModel) { return _this.keybindingsEditorModel = keybindingsModel; })
                    .then(function () { return _this.keybindingsEditorModel.resolve(); })
                    .then(function () { return _this.renderKeybindingsEntries(false); });
            }
            return winjs_base_1.TPromise.as(null);
        };
        ...
        KeybindingsEditor.prototype.renderKeybindingsEntries = function (reset) {
        ...
        KeybindingsEditor.prototype.createShowConflictsAction = function (keybindingItem) {
            var _this = this;
            return {
                label: nls_1.localize('showConflictsLabel', "Show Conflicts"),
                enabled: !!keybindingItem.keybindingItem.keybinding,
                id: preferences_1.KEYBINDINGS_EDITOR_COMMAND_SHOW_CONFLICTS,
                run: function () { return _this.showConflicts(keybindingItem); }
            };
        };
    ...
    var KeybindingHeaderRenderer = (function () {
    ...
    var KeybindingItemRenderer = (function () {
    ...
    var CommandColumn = (function (_super) {
        ...
        CommandColumn.prototype.render = function (keybindingItemEntry) {
            ...
            if (keybindingItem.commandLabel) {
                var commandLabel = new highlightedLabel_1.HighlightedLabel(this.commandColumn);
            ...
            if (keybindingItemEntry.commandDefaultLabelMatches) {
                new highlightedLabel_1.HighlightedLabel(DOM.append(this.commandColumn, $('.command-default-label'))).set(keybindingItem.commandDefaultLabel, keybindingItemEntry.commandDefaultLabelMatches);
            }
            if (keybindingItemEntry.commandIdMatches || !keybindingItem.commandLabel) {
                new highlightedLabel_1.HighlightedLabel(DOM.append(this.commandColumn, $('.code'))).set(keybindingItem.command, keybindingItemEntry.commandIdMatches);
            }
        };
    ...
    var KeybindingColumn = (function (_super) {
    ...
    var SourceColumn = (function (_super) {
    ...
    var WhenColumn = (function (_super) {
