...
define(["require", "exports", "vs/nls", "vs/base/common/arrays", "vs/base/common/strings", "vs/base/common/platform", "vs/base/common/filters", "vs/platform/registry/common/platform", "vs/base/common/keybindingLabels", "vs/editor/common/editorCommonExtensions", "vs/platform/actions/common/actions", "vs/workbench/common/actionRegistry", "vs/workbench/common/editor", "vs/platform/extensions/common/extensions", "vs/platform/keybinding/common/keybinding", "vs/platform/keybinding/common/resolvedKeybindingItem", "vs/platform/keybinding/common/keybindingResolver"], function (require, exports, nls_1, arrays_1, strings, platform_1, filters_1, platform_2, keybindingLabels_1, editorCommonExtensions_1, actions_1, actionRegistry_1, editor_1, extensions_1, keybinding_1, resolvedKeybindingItem_1, keybindingResolver_1) {
    "use strict";
    ...
    var KeybindingsEditorModel = (function (_super) {
        ...
        KeybindingsEditorModel.prototype.resolve = function () {
            var _this = this;
            return this.extensionService.onReady()
                ...
                var editorActions = editorCommonExtensions_1.CommonEditorRegistry.getEditorActions().reduce(function (editorActions, editorAction) {
                ...
                for (var _i = 0, _a = _this.keybindingsService.getKeybindings(); _i < _a.length; _i++) {
                    ...
                    if (keybinding.command) {
                        _this._keybindingItemsSortedByPrecedence.push(KeybindingsEditorModel.toKeybindingEntry(keybinding.command, keybinding, workbenchActionsRegistry, editorActions));
                ...
                for (var _b = 0, _c = keybindingResolver_1.KeybindingResolver.getAllUnboundCommands(boundCommands); _b < _c.length; _b++) {
                    ...
                    _this._keybindingItemsSortedByPrecedence.push(KeybindingsEditorModel.toKeybindingEntry(command, keybindingItem, workbenchActionsRegistry, editorActions));
                }
        ...
        KeybindingsEditorModel.toKeybindingEntry = function (command, keybindingItem, workbenchActionsRegistry, editorActions) {
            var workbenchAction = workbenchActionsRegistry.getWorkbenchAction(command);
            var menuCommand = actions_1.MenuRegistry.getCommand(command);
            var editorAction = editorActions[command];
            return {
        ...
        KeybindingsEditorModel.getCommandDefaultLabel = function (workbenchAction, menuCommand, workbenchActionsRegistry) {
        ...
        KeybindingsEditorModel.getCommandLabel = function (workbenchAction, menuCommand, editorAction) {
            if (workbenchAction) {
    ...
    var KeybindingItemMatches = (function () {
        function KeybindingItemMatches(modifierLabels, keybindingItem, searchValue, words, keybindingWords, completeMatch) {
            ...
            this.words = words;
            this.keybindingWords = keybindingWords;
