...
define(["require", "exports", "assert", "vs/base/common/uri", "vs/base/common/severity", "vs/workbench/parts/markers/common/markersModel"], function (require, exports, assert, uri_1, severity_1, markersModel_1) {
    ...
    suite('MarkersModel Test', function () {
        ...
        test('toString()', function () {
            assert.equal("file: 'file:///a/res1'\nseverity: 'Error'\nmessage: 'some message'\nat: '10,5'\nsource: 'tslint'", new markersModel_1.Marker('', aMarker('a/res1')).toString());
            assert.equal("file: 'file:///a/res2'\nseverity: 'Warning'\nmessage: 'some message'\nat: '10,5'\nsource: 'tslint'", new markersModel_1.Marker('', aMarker('a/res2', severity_1.default.Warning)).toString());
            assert.equal("file: 'file:///a/res2'\nseverity: 'Info'\nmessage: 'Info'\nat: '1,2'\nsource: ''", new markersModel_1.Marker('', aMarker('a/res2', severity_1.default.Info, 1, 2, 1, 8, 'Info', '')).toString());
            assert.equal("file: 'file:///a/res2'\nseverity: ''\nmessage: 'Ignore message'\nat: '1,2'\nsource: 'Ignore'", new markersModel_1.Marker('', aMarker('a/res2', severity_1.default.Ignore, 1, 2, 1, 8, 'Ignore message', 'Ignore')).toString());
        });
