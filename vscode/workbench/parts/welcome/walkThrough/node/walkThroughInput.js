...
define(["require", "exports", "vs/base/common/strings", "vs/base/common/winjs.base", "vs/workbench/common/editor", "vs/base/common/lifecycle", "vs/platform/telemetry/common/telemetryUtils", "vs/editor/common/services/resolverService", "vs/base/common/marked/marked", "vs/base/common/network", "vs/platform/telemetry/common/telemetry", "vs/platform/lifecycle/common/lifecycle"], function (require, exports, strings, winjs_base_1, editor_1, lifecycle_1, telemetryUtils_1, resolverService_1, marked_1, network_1, telemetry_1, lifecycle_2) {
    /*---------------------------------------------------------------------------------------------
    ...
    var WalkThroughInput = (function (_super) {
        ...
        function WalkThroughInput(options, telemetryService, lifecycleService, textModelResolverService) {
            var _this = _super.call(this) || this;
        ...
        WalkThroughInput.prototype.getTelemetryDescriptor = function () {
            ...
            descriptor['resource'] = telemetryUtils_1.telemetryURIDescriptor(this.options.resource);
            return descriptor;
        };
