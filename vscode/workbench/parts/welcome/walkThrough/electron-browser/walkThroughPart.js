...
define(["require", "exports", "vs/base/browser/ui/scrollbar/scrollableElement", "vs/base/common/scrollable", "vs/base/common/strings", "vs/base/common/uri", "vs/base/common/winjs.base", "vs/base/browser/builder", "vs/base/common/lifecycle", "vs/workbench/browser/parts/editor/baseEditor", "vs/platform/telemetry/common/telemetry", "vs/workbench/parts/welcome/walkThrough/node/walkThroughInput", "vs/platform/opener/common/opener", "vs/base/common/marked/marked", "vs/editor/common/services/modeService", "vs/platform/files/common/files", "vs/editor/common/services/modelService", "vs/editor/browser/codeEditor", "vs/platform/instantiation/common/instantiation", "vs/platform/keybinding/common/keybinding", "vs/nls", "vs/platform/storage/common/storage", "vs/workbench/common/memento", "vs/platform/contextkey/common/contextkey", "vs/platform/configuration/common/configuration", "vs/base/common/event", "vs/base/common/types", "vs/platform/commands/common/commands", "vs/editor/common/services/codeEditorService", "vs/workbench/services/part/common/partService", "vs/platform/message/common/message", "vs/platform/theme/common/themeService", "vs/platform/theme/common/colorRegistry", "vs/workbench/parts/welcome/walkThrough/node/walkThroughUtils", "vs/base/common/keybindingLabels", "vs/base/common/platform", "vs/css!./walkThroughPart"], function (require, exports, scrollableElement_1, scrollable_1, strings, uri_1, winjs_base_1, builder_1, lifecycle_1, baseEditor_1, telemetry_1, walkThroughInput_1, opener_1, marked_1, modeService_1, files_1, modelService_1, codeEditor_1, instantiation_1, keybinding_1, nls_1, storage_1, memento_1, contextkey_1, configuration_1, event_1, types_1, commands_1, codeEditorService_1, partService_1, message_1, themeService_1, colorRegistry_1, walkThroughUtils_1, keybindingLabels_1, platform_1) {
    'use strict';
    ...
    var WalkThroughPart = (function (_super) {
        ...
        function WalkThroughPart(telemetryService, instantiationService, themeService, openerService, fileService, modelService, keybindingService, storageService, contextKeyService, configurationService, modeService, messageService, partService) {
        ...
        WalkThroughPart.prototype.setInput = function (input, options) {
            ...
            return _super.prototype.setInput.call(this, input, options)
                ...
                model.snippets.forEach(function (snippet, i) {
                    ...
                    _this.contentDisposables.push(_this.configurationService.onDidUpdateConfiguration(function () {
                ...
                _this.contentDisposables.push(_this.configurationService.onDidUpdateConfiguration(function () { return _this.multiCursorModifier(); }));
                if (input.onReady) {
        ...
        WalkThroughPart.prototype.getEditorOptions = function (language) {
            var config = this.configurationService.getConfiguration('editor', { overrideIdentifier: language });
        ...
        WalkThroughPart.prototype.multiCursorModifier = function () {
            ...
            var setting = this.configurationService.lookup('editor.multiCursorModifier');
            var modifier = labels[setting.value === 'ctrlCmd' ? (platform_1.OS === 2 /* Macintosh */ ? 'metaKey' : 'ctrlKey') : 'altKey'];
