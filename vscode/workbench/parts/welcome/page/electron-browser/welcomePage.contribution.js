define(["require", "exports", "vs/nls", "vs/workbench/common/contributions", "vs/platform/registry/common/platform", "vs/workbench/parts/welcome/page/electron-browser/welcomePage", "vs/workbench/common/actionRegistry", "vs/platform/actions/common/actions", "vs/platform/configuration/common/configurationRegistry", "vs/workbench/common/editor"], function (require, exports, nls_1, contributions_1, platform_1, welcomePage_1, actionRegistry_1, actions_1, configurationRegistry_1, editor_1) {
    /*---------------------------------------------------------------------------------------------
    ...
    platform_1.Registry.as(contributions_1.Extensions.Workbench)
        .registerWorkbenchContribution(welcomePage_1.WelcomePageContribution);
    platform_1.Registry.as(actionRegistry_1.Extensions.WorkbenchActions)
        .registerWorkbenchAction(new actions_1.SyncActionDescriptor(welcomePage_1.WelcomePageAction, welcomePage_1.WelcomePageAction.ID, welcomePage_1.WelcomePageAction.LABEL), 'Help: Welcome', nls_1.localize('help', "Help"));
    platform_1.Registry.as(editor_1.Extensions.Editors).registerEditorInputFactory(welcomePage_1.WelcomeInputFactory.ID, welcomePage_1.WelcomeInputFactory);
});
