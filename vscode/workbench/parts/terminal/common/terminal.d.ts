...
export declare const KEYBINDING_CONTEXT_TERMINAL_FIND_WIDGET_VISIBLE: RawContextKey<boolean>;
/**  A context key that is set when the find widget in integrated terminal is not visible. */
export declare const KEYBINDING_CONTEXT_TERMINAL_FIND_WIDGET_NOT_VISIBLE: ContextKeyExpr;
/**  A context key that is set when the find widget find input in integrated terminal is focused. */
export declare const KEYBINDING_CONTEXT_TERMINAL_FIND_WIDGET_INPUT_FOCUSED: RawContextKey<boolean>;
/**  A context key that is set when the find widget find input in integrated terminal is not focused. */
export declare const KEYBINDING_CONTEXT_TERMINAL_FIND_WIDGET_INPUT_NOT_FOCUSED: ContextKeyExpr;
export declare const IS_WORKSPACE_SHELL_ALLOWED_STORAGE_KEY = "terminal.integrated.isWorkspaceShellAllowed";
export declare const NEVER_SUGGEST_SELECT_WINDOWS_SHELL_STORAGE_KEY = "terminal.integrated.neverSuggestSelectWindowsShell";
