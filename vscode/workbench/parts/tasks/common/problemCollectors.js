...
define(["require", "exports", "vs/base/common/uri", "vs/base/common/eventEmitter", "vs/platform/markers/common/problemMatcher", "vs/platform/markers/common/markers"], function (require, exports, uri_1, eventEmitter_1, problemMatcher_1, markers_1) {
    /*---------------------------------------------------------------------------------------------
    ...
    var AbstractProblemCollector = (function (_super) {
        ...
        function AbstractProblemCollector(problemMatchers, markerService, modelService) {
            ...
            _this.applyToByOwner = new Map();
            for (var _i = 0, problemMatchers_1 = problemMatchers; _i < problemMatchers_1.length; _i++) {
                var problemMatcher = problemMatchers_1[_i];
                var current = _this.applyToByOwner.get(problemMatcher.owner);
                if (current === void 0) {
                    _this.applyToByOwner.set(problemMatcher.owner, problemMatcher.applyTo);
                }
                else {
                    _this.applyToByOwner.set(problemMatcher.owner, _this.mergeApplyTo(current, problemMatcher.applyTo));
                }
            }
            _this.resourcesToClean = new Map();
            _this.markers = new Map();
            _this.deliveredMarkers = new Map();
    ...
    var WatchingProblemCollector = (function (_super) {
        ...
        WatchingProblemCollector.prototype.done = function () {
            this.reportMarkers();
            this.cleanAllMarkers();
        };
