...
define(["require", "exports", "vs/nls", "vs/base/common/filters", "vs/base/common/actions", "vs/workbench/browser/quickopen", "vs/base/parts/quickopen/browser/quickOpenModel", "vs/platform/quickOpen/common/quickOpen", "vs/workbench/parts/tasks/common/tasks", "vs/workbench/parts/tasks/common/taskService", "vs/workbench/browser/actions"], function (require, exports, nls, Filters, actions_1, Quickopen, Model, quickOpen_1, tasks_1, taskService_1, actions_2) {
    ...
    var TaskEntry = (function (_super) {
        ...
        function TaskEntry(taskService, quickOpenService, _task, highlights) {
    ...
    var TaskGroupEntry = (function (_super) {
    ...
    var QuickOpenHandler = (function (_super) {
        ...
        QuickOpenHandler.prototype.getResults = function (input) {
            ...
            return this.tasks.then(function (tasks) {
                ...
                tasks.forEach(function (task) { return taskMap[tasks_1.Task.getKey(task)] = task; });
    ...
    var CustomizeTaskAction = (function (_super) {
        __extends(CustomizeTaskAction, _super);
        function CustomizeTaskAction(taskService, quickOpenService, task) {
        ...
        CustomizeTaskAction.prototype.run = function (context) {
            var _this = this;
            if (tasks_1.ContributedTask.is(this.task)) {
                return this.taskService.customize(this.task, undefined, true).then(function () {
                    _this.quickOpenService.close();
                });
            }
            else {
                return this.taskService.openConfig(this.task).then(function () {
                    _this.quickOpenService.close();
                });
            }
        };
