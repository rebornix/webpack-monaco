define(["require", "exports", "assert", "vs/base/common/severity", "vs/base/common/uuid", "vs/base/common/platform", "vs/base/common/parsers", "vs/platform/markers/common/problemMatcher", "vs/workbench/parts/tasks/common/tasks", "vs/workbench/parts/tasks/node/taskConfiguration"], function (require, exports, assert, severity_1, UUID, Platform, parsers_1, problemMatcher_1, Tasks, taskConfiguration_1) {
    /*---------------------------------------------------------------------------------------------
    ...
    var PresentationBuilder = (function () {
    ...
    var CommandConfigurationBuilder = (function () {
    ...
    var CustomTaskBuilder = (function () {
        ...
        CustomTaskBuilder.prototype.isPrimary = function (value) {
    ...
    function testDefaultProblemMatcher(external, resolved) {
        ...
        var result = taskConfiguration_1.parse(external, reporter);
