...
define(["require", "exports", "vs/nls", "vs/editor/common/editorCommonExtensions", "vs/editor/common/services/codeEditorService", "vs/platform/actions/common/actions", "vs/platform/contextkey/common/contextkey", "vs/base/common/lifecycle", "vs/platform/message/common/message", "vs/base/common/severity", "vs/editor/common/config/editorOptions", "vs/editor/common/services/resourceConfiguration", "vs/css!./media/codeEditor"], function (require, exports, nls, editorCommonExtensions_1, codeEditorService_1, actions_1, contextkey_1, lifecycle_1, message_1, severity_1, editorOptions_1, resourceConfiguration_1) {
    /*---------------------------------------------------------------------------------------------
    ...
    function readWordWrapState(model, configurationService, codeEditorService) {
        var editorConfig = configurationService.getConfiguration(model.uri, 'editor');
    ...
    var ToggleWordWrapController = (function (_super) {
        ...
        ToggleWordWrapController_1 = ToggleWordWrapController;
        ...
        ToggleWordWrapController.prototype.getId = function () {
            return ToggleWordWrapController_1._ID;
        };
        ToggleWordWrapController._ID = 'editor.contrib.toggleWordWrapController';
        ToggleWordWrapController = ToggleWordWrapController_1 = __decorate([
        ...
        var ToggleWordWrapController_1;
