...
define(["require", "exports", "vs/nls", "vs/base/common/winjs.base", "vs/base/common/actions", "vs/base/common/platform", "vs/editor/common/services/modelService", "vs/workbench/common/contributions", "vs/platform/registry/common/platform", "vs/platform/message/common/message", "vs/platform/instantiation/common/instantiation", "vs/platform/telemetry/common/telemetry", "vs/platform/files/common/files", "vs/platform/storage/common/storage", "vs/platform/node/package", "vs/platform/node/product"], function (require, exports, nls, winjs_base_1, actions_1, platform_1, modelService_1, contributions_1, platform_2, message_1, instantiation_1, telemetry_1, files_1, storage_1, package_1, product_1) {
    'use strict';
    Object.defineProperty(exports, "__esModule", { value: true });
    var LanguageSurvey = (function () {
    ...
    var LanguageSurveysContribution = (function () {
        function LanguageSurveysContribution(instantiationService, storageService, messageService, telemetryService, fileService, modelService) {
            this.surveys = product_1.default.surveys.filter(function (surveyData) { return surveyData.surveyId && surveyData.editCount && surveyData.languageId && surveyData.surveyUrl && surveyData.userProbability; }).map(function (surveyData) {
        ...
        LanguageSurveysContribution.prototype.getId = function () {
