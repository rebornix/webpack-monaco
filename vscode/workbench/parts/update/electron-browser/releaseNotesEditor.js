...
define(["require", "exports", "vs/base/common/winjs.base", "vs/base/common/marked/marked", "vs/base/common/lifecycle", "vs/base/browser/dom", "vs/platform/telemetry/common/telemetry", "vs/platform/theme/common/themeService", "./releaseNotesInput", "vs/workbench/parts/html/browser/webview", "vs/platform/opener/common/opener", "vs/editor/common/services/modeService", "vs/editor/common/modes/textToHtmlTokenizer", "vs/workbench/services/part/common/partService", "vs/workbench/parts/html/browser/webviewEditor", "vs/platform/storage/common/storage", "vs/platform/contextview/browser/contextView", "vs/platform/contextkey/common/contextkey"], function (require, exports, winjs_base_1, marked_1, lifecycle_1, dom_1, telemetry_1, themeService_1, releaseNotesInput_1, webview_1, opener_1, modeService_1, textToHtmlTokenizer_1, partService_1, webviewEditor_1, storage_1, contextView_1, contextkey_1) {
    ...
    var ReleaseNotesEditor = (function (_super) {
        ...
        function ReleaseNotesEditor(telemetryService, themeService, openerService, modeService, partService, storageService, _contextViewService, contextKeyService) {
        ...
        ReleaseNotesEditor.prototype.setInput = function (input, options) {
            return __awaiter(this, void 0, winjs_base_1.TPromise, function () {
                var _this = this;
                var text, result, renderer, body, state;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            ...
                            body = renderBody(marked_1.marked(text, { renderer: renderer }));
                            this._webview = new webview_1.default(this.content, this.partService.getContainer(partService_1.Parts.EDITOR_PART), this._contextViewService, this.contextKey, this.findInputFocusContextKey);
                            ...
                            this._webview.onDidClickLink(function (link) { return _this.openerService.open(link); }, null, this.contentDisposables);
