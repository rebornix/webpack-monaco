 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/base/common/types", "vs/base/common/platform", "vs/base/common/uri", "vs/base/common/paths", "vs/workbench/parts/files/browser/fileActions", "vs/workbench/parts/files/common/explorerModel"], function (require, exports, assert, types_1, platform_1, uri_1, paths_1, fileActions_1, explorerModel_1) {
    'use strict';
    Object.defineProperty(exports, "__esModule", { value: true });
    function createStat(path, name, isFolder, hasChildren, size, mtime) {
        return new explorerModel_1.FileStat(toResource(path), undefined, isFolder, hasChildren, name, mtime);
    }
    ...
    suite('Files - View Model', function () {
        ...
        test('Merge Local with Disk', function () {
            ...
            var merge1 = new explorerModel_1.FileStat(uri_1.default.file(paths_1.join('C:\\', '/path/to')), undefined, true, false, 'to', Date.now(), d);
            var merge2 = new explorerModel_1.FileStat(uri_1.default.file(paths_1.join('C:\\', '/path/to')), undefined, true, false, 'to', Date.now(), new Date(0).toUTCString());
            // Merge Properties
            ...
            merge2.addChild(new explorerModel_1.FileStat(uri_1.default.file(paths_1.join('C:\\', '/path/to/foo.html')), undefined, true, false, 'foo.html', Date.now(), d));
            explorerModel_1.FileStat.mergeLocalWithDisk(merge2, merge1);
            assert.strictEqual(merge1.children.length, 0);
            // Merge Child with isDirectoryResolved=true
            var child = new explorerModel_1.FileStat(uri_1.default.file(paths_1.join('C:\\', '/path/to/foo.html')), undefined, true, false, 'foo.html', Date.now(), d);
