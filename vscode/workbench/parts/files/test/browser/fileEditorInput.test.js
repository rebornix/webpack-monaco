...
define(["require", "exports", "assert", "vs/base/common/uri", "vs/base/common/paths", "vs/workbench/parts/files/common/editors/fileEditorInput", "vs/workbench/services/editor/common/editorService", "vs/workbench/test/workbenchTestServices", "vs/workbench/common/editor", "vs/workbench/services/textfile/common/textfiles", "vs/platform/files/common/files", "vs/platform/editor/common/editor", "vs/workbench/services/group/common/groupService", "vs/editor/common/services/modelService"], function (require, exports, assert, uri_1, paths_1, fileEditorInput_1, editorService_1, workbenchTestServices_1, editor_1, textfiles_1, files_1, editor_2, groupService_1, modelService_1) {
    ...
    function toResource(path) {
        return uri_1.default.file(paths_1.join('C:\\', new Buffer(this.test.fullTitle()).toString('base64'), path));
    }
    ...
    suite('Files - FileEditorInput', function () {
        ...
        test('Basics', function (done) {
            var input = instantiationService.createInstance(fileEditorInput_1.FileEditorInput, toResource.call(this, '/foo/bar/file.js'), void 0);
            var otherInput = instantiationService.createInstance(fileEditorInput_1.FileEditorInput, toResource.call(this, 'foo/bar/otherfile.js'), void 0);
            var otherInputSame = instantiationService.createInstance(fileEditorInput_1.FileEditorInput, toResource.call(this, 'foo/bar/file.js'), void 0);
            ...
            input = instantiationService.createInstance(fileEditorInput_1.FileEditorInput, toResource.call(this, '/foo/bar.html'), void 0);
            var inputToResolve = instantiationService.createInstance(fileEditorInput_1.FileEditorInput, toResource.call(this, '/foo/bar/file.js'), void 0);
            var sameOtherInput = instantiationService.createInstance(fileEditorInput_1.FileEditorInput, toResource.call(this, '/foo/bar/file.js'), void 0);
        ...
        test('matches', function () {
            var input1 = instantiationService.createInstance(fileEditorInput_1.FileEditorInput, toResource.call(this, '/foo/bar/updatefile.js'), void 0);
            var input2 = instantiationService.createInstance(fileEditorInput_1.FileEditorInput, toResource.call(this, '/foo/bar/updatefile.js'), void 0);
            var input3 = instantiationService.createInstance(fileEditorInput_1.FileEditorInput, toResource.call(this, '/foo/bar/other.js'), void 0);
            var input2Upper = instantiationService.createInstance(fileEditorInput_1.FileEditorInput, toResource.call(this, '/foo/bar/UPDATEFILE.js'), void 0);
        ...
        test('getEncoding/setEncoding', function (done) {
            var input = instantiationService.createInstance(fileEditorInput_1.FileEditorInput, toResource.call(this, '/foo/bar/updatefile.js'), void 0);
        ...
        test('disposes model when not open anymore', function (done) {
            var resource = toResource.call(this, '/path/index.txt');
