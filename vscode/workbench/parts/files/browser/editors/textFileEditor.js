...
define(["require", "exports", "vs/base/common/winjs.base", "vs/nls", "vs/base/common/errors", "vs/base/common/errorMessage", "vs/base/common/types", "vs/base/common/paths", "vs/base/common/actions", "vs/workbench/parts/files/common/files", "vs/workbench/services/textfile/common/textfiles", "vs/workbench/browser/parts/editor/textEditor", "vs/workbench/common/editor/binaryEditorModel", "vs/workbench/services/viewlet/browser/viewlet", "vs/platform/files/common/files", "vs/platform/telemetry/common/telemetry", "vs/platform/workspace/common/workspace", "vs/platform/storage/common/storage", "vs/editor/common/services/resourceConfiguration", "vs/workbench/services/history/common/history", "vs/platform/instantiation/common/instantiation", "vs/platform/message/common/message", "vs/workbench/services/editor/common/editorService", "vs/platform/theme/common/themeService", "vs/workbench/services/group/common/groupService", "vs/editor/common/services/modeService"], function (require, exports, winjs_base_1, nls, errors, errorMessage_1, types, paths, actions_1, files_1, textfiles_1, textEditor_1, binaryEditorModel_1, viewlet_1, files_2, telemetry_1, workspace_1, storage_1, resourceConfiguration_1, history_1, instantiation_1, message_1, editorService_1, themeService_1, groupService_1, modeService_1) {
    ...
    var TextFileEditor = (function (_super) {
        ...
        function TextFileEditor(telemetryService, fileService, viewletService, instantiationService, contextService, storageService, historyService, configurationService, editorService, themeService, editorGroupService, modeService, textFileService) {
            var _this = _super.call(this, TextFileEditor.ID, telemetryService, instantiationService, storageService, configurationService, themeService, modeService, textFileService, editorGroupService) || this;
        ...
        TextFileEditor.prototype.onFilesChanged = function (e) {
            ...
            if (deleted && deleted.length) {
                this.clearTextEditorViewState(deleted.map(function (d) { return d.resource.toString(); }));
            }
        };
        ...
        TextFileEditor.prototype.setInput = function (input, options) {
            ...
            return input.resolve(true).then(function (resolvedModel) {
                ...
                var editorViewState = _this.loadTextEditorViewState(_this.input.getResource().toString());
                if (editorViewState) {
        ...
        TextFileEditor = __decorate([
            ...
            __param(12, textfiles_1.ITextFileService)
        ], TextFileEditor);
