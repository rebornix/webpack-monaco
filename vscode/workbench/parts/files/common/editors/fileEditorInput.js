...
define(["require", "exports", "vs/nls", "vs/base/common/winjs.base", "vs/base/common/paths", "vs/base/common/labels", "vs/workbench/common/editor", "vs/workbench/common/editor/binaryEditorModel", "vs/platform/files/common/files", "vs/workbench/parts/files/common/files", "vs/workbench/services/textfile/common/textfiles", "vs/platform/workspace/common/workspace", "vs/platform/instantiation/common/instantiation", "vs/base/common/lifecycle", "vs/platform/telemetry/common/telemetryUtils", "vs/platform/editor/common/editor", "vs/platform/environment/common/environment", "vs/editor/common/services/resolverService"], function (require, exports, nls_1, winjs_base_1, paths, labels, editor_1, binaryEditorModel_1, files_1, files_2, textfiles_1, workspace_1, instantiation_1, lifecycle_1, telemetryUtils_1, editor_2, environment_1, resolverService_1) {
    /*---------------------------------------------------------------------------------------------
    ...
    var FileEditorInput = (function (_super) {
         ...
         */
        function FileEditorInput(resource, preferredEncoding, instantiationService, contextService, textFileService, environmentService, textModelResolverService) {
        ...
        FileEditorInput.prototype.resolveAsBinary = function () {
            return this.instantiationService.createInstance(binaryEditorModel_1.BinaryEditorModel, this.resource, this.getName())
                .load()
