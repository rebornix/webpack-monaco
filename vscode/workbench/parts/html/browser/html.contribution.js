define(["require", "exports", "vs/base/common/uri", "vs/nls", "vs/platform/commands/common/commands", "vs/platform/instantiation/common/instantiation", "vs/workbench/services/editor/common/editorService", "../common/htmlInput", "vs/workbench/parts/html/browser/htmlPreviewPart", "vs/platform/registry/common/platform", "vs/workbench/browser/parts/editor/baseEditor", "vs/workbench/common/editor", "vs/platform/instantiation/common/descriptors", "vs/workbench/services/group/common/groupService", "vs/platform/actions/common/actions", "vs/workbench/parts/extensions/common/extensions", "vs/css!./media/htmlPreviewPart"], function (require, exports, uri_1, nls_1, commands_1, instantiation_1, editorService_1, htmlInput_1, htmlPreviewPart_1, platform_1, baseEditor_1, editor_1, descriptors_1, groupService_1, actions_1, extensions_1) {
    ...
    commands_1.CommandsRegistry.registerCommand('_workbench.htmlPreview.updateOptions', function (accessor, resource, options) {
        var extensionsWorkbenchService = accessor.get(extensions_1.IExtensionsWorkbenchService);
        var inputOptions = options;
        var allowedBadgeProviders = extensionsWorkbenchService.allowedBadgeProviders;
        inputOptions.svgWhiteList = allowedBadgeProviders;
        var uri = resource instanceof uri_1.default ? resource : uri_1.default.parse(resource);
        var activePreviews = getActivePreviewsForResource(accessor, resource);
        for (var _i = 0, activePreviews_2 = activePreviews; _i < activePreviews_2.length; _i++) {
            var preview = activePreviews_2[_i];
            if (preview.input && preview.input instanceof htmlInput_1.HtmlInput) {
                var input = accessor.get(instantiation_1.IInstantiationService).createInstance(htmlInput_1.HtmlInput, preview.input.getName(), '', uri, options);
