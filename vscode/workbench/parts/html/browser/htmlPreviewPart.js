...
define(["require", "exports", "vs/nls", "vs/base/common/winjs.base", "vs/base/common/lifecycle", "vs/platform/telemetry/common/telemetry", "vs/workbench/common/editor/textEditorModel", "vs/workbench/parts/html/common/htmlInput", "vs/platform/theme/common/themeService", "vs/platform/opener/common/opener", "vs/editor/common/services/resolverService", "vs/workbench/services/part/common/partService", "vs/platform/contextview/browser/contextView", "vs/platform/contextkey/common/contextkey", "./webview", "vs/platform/storage/common/storage", "./webviewEditor"], function (require, exports, nls_1, winjs_base_1, lifecycle_1, telemetry_1, textEditorModel_1, htmlInput_1, themeService_1, opener_1, resolverService_1, partService_1, contextView_1, contextkey_1, webview_1, storage_1, webviewEditor_1) {
    'use strict';
    ...
    var HtmlPreviewPart = (function (_super) {
        ...
        function HtmlPreviewPart(telemetryService, textModelResolverService, themeService, openerService, partService, storageService, _contextViewService, contextKeyService) {
        ...
        Object.defineProperty(HtmlPreviewPart.prototype, "webview", {
            get: function () {
                ...
                if (!this._webview) {
                    ...
                    this._webview = new webview_1.default(this.content, this.partService.getContainer(partService_1.Parts.EDITOR_PART), this._contextViewService, this.contextKey, this.findInputFocusContextKey, webviewOptions);
                    if (this.input && this.input instanceof htmlInput_1.HtmlInput) {
        ...
        HtmlPreviewPart.prototype._doSetVisible = function (visible) {
            ...
            if (!visible) {
                ...
                if (this._hasValidModel()) {
                    this._modelChangeSubscription = this.model.onDidChangeContent(function () { return _this.webview.contents = _this.model.getLinesContent(); });
            ...
            return _super.prototype.setInput.call(this, input, options).then(function () {
                ...
                return _this.textModelResolverService.createModelReference(resourceUri).then(function (ref) {
                    ...
                    _this._modelChangeSubscription = _this.model.onDidChangeContent(function () {
                        if (_this.model) {
                            _this.scrollYPercentage = 0;
                            _this.webview.contents = _this.model.getLinesContent();
                        }
                    });
