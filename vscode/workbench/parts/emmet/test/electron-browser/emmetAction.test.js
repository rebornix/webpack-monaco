 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "vs/workbench/parts/emmet/electron-browser/emmetActions", "vs/editor/test/common/mocks/mockCodeEditor", "assert", "vs/editor/common/modes"], function (require, exports, emmetActions_1, mockCodeEditor_1, assert, modes_1) {
    'use strict';
    ...
    //
    var MockGrammarContributions = (function () {
    ...
    suite('Emmet', function () {
        test('Get language mode and parent mode for emmet', function () {
            mockCodeEditor_1.withMockCodeEditor([], {}, function (editor) {
