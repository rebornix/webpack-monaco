...
define(["require", "exports", "vs/base/common/paths", "vs/base/common/objects", "vs/base/common/strings", "vs/base/common/errors", "vs/base/common/async", "vs/base/common/lifecycle", "vs/base/common/uri", "vs/base/common/map", "vs/base/common/event", "vs/platform/search/common/search", "vs/platform/search/common/replace", "vs/platform/telemetry/common/telemetry", "vs/editor/common/core/range", "vs/editor/common/editorCommon", "vs/platform/instantiation/common/instantiation", "vs/editor/common/services/modelService", "vs/workbench/parts/search/common/replace", "vs/workbench/common/editor/rangeDecorations", "vs/editor/common/model/textModelWithDecorations", "vs/platform/theme/common/colorRegistry", "vs/platform/theme/common/themeService"], function (require, exports, paths, objects, strings, errors, async_1, lifecycle_1, uri_1, map_1, event_1, search_1, replace_1, telemetry_1, range_1, editorCommon_1, instantiation_1, modelService_1, replace_2, rangeDecorations_1, textModelWithDecorations_1, colorRegistry_1, themeService_1) {
    "use strict";
    ...
    var FileMatch = (function (_super) {
        ...
        FileMatch._CURRENT_FIND_MATCH = textModelWithDecorations_1.ModelDecorationOptions.register({
        ...
        FileMatch._FIND_MATCH = textModelWithDecorations_1.ModelDecorationOptions.register({
            stickiness: editorCommon_1.TrackedRangeStickiness.NeverGrowsWhenTypingAtEdges,
            className: 'findMatch',
            overviewRuler: {
                color: themeService_1.themeColorFromId(colorRegistry_1.editorFindMatchHighlight),
    ...
    var FolderMatch = (function (_super) {
        __extends(FolderMatch, _super);
        function FolderMatch(_resource, _id, _index, _query, _parent, _searchModel, replaceService, telemetryService, instantiationService) {
            var _this = _super.call(this) || this;
        ...
        FolderMatch = __decorate([
            __param(6, replace_2.IReplaceService), __param(7, telemetry_1.ITelemetryService),
    ...
    var SearchResult = (function (_super) {
        ...
        function SearchResult(_searchModel, replaceService, telemetryService, instantiationService) {
            ...
            _this._folderMatchesMap = new map_1.TrieMap();
            _this._query = null;
        ...
        Object.defineProperty(SearchResult.prototype, "query", {
            set: function (query) {
                ...
                this._folderMatches.slice(0, this.folderMatches.length - 1)
                    .forEach(function (fm) { return _this._folderMatchesMap.insert(fm.resource().fsPath, fm); });
            },
            enumerable: true,
            configurable: true
        });
        ...
        SearchResult.prototype.folderCount = function () {
            return this.folderMatches().reduce(function (prev, match) { return prev + (match.fileCount() > 0 ? 1 : 0); }, 0);
        };
        ...
        SearchResult.prototype.disposeMatches = function () {
            ...
            this._folderMatches = [];
            this._folderMatchesMap = new map_1.TrieMap();
            this._rangeHighlightDecorations.removeHighlightRange();
        };
