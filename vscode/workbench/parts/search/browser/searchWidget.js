...
define(["require", "exports", "vs/nls", "vs/base/common/strings", "vs/base/browser/dom", "vs/base/common/winjs.base", "vs/base/browser/ui/widget", "vs/base/common/actions", "vs/base/browser/ui/actionbar/actionbar", "vs/base/browser/ui/findinput/findInput", "vs/base/browser/ui/inputbox/inputBox", "vs/base/browser/ui/button/button", "vs/platform/keybinding/common/keybindingsRegistry", "vs/platform/keybinding/common/keybinding", "vs/platform/contextkey/common/contextkey", "vs/platform/contextview/browser/contextView", "vs/base/common/event", "vs/workbench/services/viewlet/browser/viewlet", "vs/workbench/parts/search/browser/searchActions", "vs/editor/contrib/find/common/findController", "vs/base/common/history", "vs/workbench/parts/search/common/constants", "vs/platform/theme/common/styler", "vs/platform/theme/common/themeService", "vs/workbench/common/theme"], function (require, exports, nls, strings, dom, winjs_base_1, widget_1, actions_1, actionbar_1, findInput_1, inputBox_1, button_1, keybindingsRegistry_1, keybinding_1, contextkey_1, contextView_1, event_1, viewlet_1, searchActions_1, findController_1, history_1, Constants, styler_1, themeService_1, theme_1) {
    ...
    var SearchWidget = (function (_super) {
        ...
        function SearchWidget(container, options, contextViewService, themeService, keyBindingService, keyBindingService2) {
        ...
        SearchWidget.prototype.renderToggleReplaceButton = function (parent) {
            ...
            this.toggleReplaceButton.addListener('click', function () { return _this.onToggleReplaceButton(); });
        ...
        SearchWidget.prototype.renderSearchInput = function (parent, options) {
            ...
            var inputOptions = {
                ...
                appendCaseSensitiveLabel: searchActions_1.appendKeyBindingLabel('', this.keyBindingService2.lookupKeybinding(Constants.ToggleCaseSensitiveActionId), this.keyBindingService2),
                appendWholeWordsLabel: searchActions_1.appendKeyBindingLabel('', this.keyBindingService2.lookupKeybinding(Constants.ToggleWholeWordActionId), this.keyBindingService2),
                appendRegexLabel: searchActions_1.appendKeyBindingLabel('', this.keyBindingService2.lookupKeybinding(Constants.ToggleRegexActionId), this.keyBindingService2)
            };
            ...
            this._register(this.searchInputFocusTracker.addBlurListener(function () {
                _this.searchInputBoxFocused.set(false);
            }));
        };
        SearchWidget.prototype.renderReplaceInput = function (parent) {
            ...
            this._register(this.replaceInputFocusTracker.addFocusListener(function () {
                _this.replaceInputBoxFocused.set(true);
            }));
            this._register(this.replaceInputFocusTracker.addBlurListener(function () {
                _this.replaceInputBoxFocused.set(false);
            }));
        };
