...
define(["require", "exports", "vs/nls", "vs/base/common/winjs.base", "vs/base/common/event", "vs/editor/common/editorCommon", "vs/base/common/errors", "vs/base/browser/ui/aria/aria", "vs/base/common/platform", "vs/base/common/async", "vs/base/common/strings", "vs/base/common/paths", "vs/base/browser/dom", "vs/base/browser/keyboardEvent", "vs/base/browser/builder", "vs/base/browser/ui/findinput/findInput", "vs/base/parts/tree/browser/treeImpl", "vs/workbench/common/memento", "vs/workbench/parts/preferences/common/preferences", "vs/workbench/services/group/common/groupService", "vs/platform/files/common/files", "vs/workbench/browser/viewlet", "vs/workbench/parts/search/common/searchModel", "vs/workbench/parts/search/common/queryBuilder", "vs/base/browser/ui/inputbox/inputBox", "vs/workbench/services/editor/common/editorService", "vs/platform/storage/common/storage", "vs/platform/configuration/common/configuration", "vs/platform/contextview/browser/contextView", "vs/platform/instantiation/common/instantiation", "vs/platform/message/common/message", "vs/platform/progress/common/progress", "vs/platform/workspace/common/workspace", "vs/platform/contextkey/common/contextkey", "vs/platform/telemetry/common/telemetry", "vs/workbench/parts/search/browser/patternInputWidget", "vs/workbench/parts/search/browser/searchResultsView", "vs/workbench/parts/search/browser/searchWidget", "vs/workbench/parts/search/browser/searchActions", "vs/workbench/parts/search/common/replace", "vs/base/common/severity", "vs/workbench/services/untitled/common/untitledEditorService", "vs/workbench/browser/actions/workspaceActions", "vs/workbench/parts/search/common/constants", "vs/platform/list/browser/listService", "vs/platform/theme/common/themeService", "vs/platform/theme/common/colorRegistry", "vs/workbench/parts/files/browser/fileResultsNavigation", "vs/platform/theme/common/styler", "vs/workbench/parts/output/common/output", "vs/workbench/parts/search/common/search", "vs/workbench/parts/preferences/browser/preferencesEditor", "vs/base/parts/tree/browser/treeDnd", "vs/css!./media/searchviewlet"], function (require, exports, nls, winjs_base_1, event_1, editorCommon_1, errors, aria, env, async_1, strings, paths, dom, keyboardEvent_1, builder_1, findInput_1, treeImpl_1, memento_1, preferences_1, groupService_1, files_1, viewlet_1, searchModel_1, queryBuilder_1, inputBox_1, editorService_1, storage_1, configuration_1, contextView_1, instantiation_1, message_1, progress_1, workspace_1, contextkey_1, telemetry_1, patternInputWidget_1, searchResultsView_1, searchWidget_1, searchActions_1, replace_1, severity_1, untitledEditorService_1, workspaceActions_1, Constants, listService_1, themeService_1, colorRegistry_1, fileResultsNavigation_1, styler_1, output_1, search_1, preferencesEditor_1, treeDnd_1) {
    'use strict';
    Object.defineProperty(exports, "__esModule", { value: true });
    var SearchViewlet = (function (_super) {
        __extends(SearchViewlet, _super);
        function SearchViewlet(telemetryService, fileService, editorService, editorGroupService, progressService, messageService, storageService, contextViewService, instantiationService, configurationService, contextService, searchWorkbenchService, contextKeyService, replaceService, untitledEditorService, preferencesService, listService, themeService, outputService) {
        ...
        SearchViewlet.prototype.create = function (parent) {
            ...
            var useIgnoreFiles = typeof this.viewletSettings['query.useIgnoreFiles'] === 'boolean' ?
                this.viewletSettings['query.useIgnoreFiles'] :
                this.configurationService.getConfiguration().search.useIgnoreFilesByDefault;
            var useExcludeSettings = true;
            this.queryDetails = this.searchWidgetsContainer.div({ 'class': ['query-details'] }, function (builder) {
                ...
                builder.div({ 'class': 'file-types' }, function (builder) {
                    ...
                    builder.element('h4', { text: title });
                    _this.inputPatternExcludes = new patternInputWidget_1.ExcludePatternInputWidget(builder.getContainer(), _this.contextViewService, _this.themeService, _this.telemetryService, {
                        ariaLabel: nls.localize('label.excludes', 'Search Exclude Patterns')
                    });
                    _this.inputPatternExcludes.setValue(patternExclusions);
                    _this.inputPatternExcludes.setUseIgnoreFiles(useIgnoreFiles);
                    _this.inputPatternExcludes.setUseExcludeSettings(useExcludeSettings);
        ...
        SearchViewlet.prototype.createSearchResultsView = function (builder) {
            ...
            builder.div({ 'class': 'results' }, function (div) {
                ...
                var dataSource = new searchResultsView_1.SearchDataSource(_this.contextService.hasMultiFolderWorkspace());
                var renderer = _this.instantiationService.createInstance(searchResultsView_1.SearchRenderer, _this.getActionRunner(), _this);
                var dnd = new treeDnd_1.SimpleFileResourceDragAndDrop(function (obj) { return obj instanceof searchModel_1.FileMatch ? obj.resource() : void 0; });
                ...
                _this.toUnbind.push(styler_1.attachListStyler(_this.tree, _this.themeService));
                ...
                var fileResultsNavigation = _this._register(new fileResultsNavigation_1.default(_this.tree));
                _this._register(event_1.debounceEvent(fileResultsNavigation.openFile, function (last, event) { return event; }, 75, true)(function (options) {
                ...
                _this.toUnbind.push(_this.tree.onDOMFocus(function (e) {
                    var focus = _this.tree.getFocus();
                    _this.firstMatchFocused.set(_this.tree.getNavigator().first() === _this.tree.getFocus());
                ...
                _this.toUnbind.push(_this.tree.onDOMBlur(function (e) {
        ...
        SearchViewlet.prototype.getSearchTextFromEditor = function () {
            ...
            if (editorCommon_1.isCommonDiffEditor(editorControl)) {
            ...
            if (!editorCommon_1.isCommonCodeEditor(editorControl)) {
                return null;
            }
        ...
        SearchViewlet.prototype.searchInFolder = function (resource) {
            ...
            if (workspace && resource) {
                if (this.contextService.hasFolderWorkspace()) {
                    ...
                    var owningRoot = this.contextService.getRoot(resource);
                    if (owningRoot) {
                        var owningRootBasename_1 = paths.basename(owningRoot.fsPath);
                        // If this root is the only one with its basename, use a relative ./ path. If there is another, use an absolute path
                        var isUniqueRoot = workspace.roots.filter(function (root) { return paths.basename(root.fsPath) === owningRootBasename_1; }).length === 1;
                        if (isUniqueRoot) {
                            folderPath = "./" + owningRootBasename_1 + "/" + paths.relative(owningRoot.fsPath, resource.fsPath);
                        }
                        else {
        ...
        SearchViewlet.prototype.onQueryChanged = function (rerunQuery, preserveFocus) {
            ...
            var useIgnoreFiles = this.inputPatternExcludes.useIgnoreFiles();
            var useExcludeSettings = this.inputPatternExcludes.useExcludeSettings();
            if (!rerunQuery) {
                return;
            }
            ...
            var content = {
                ...
                wordSeparators: this.configurationService.getConfiguration().editor.wordSeparators
            };
            ...
            var folderResources = this.contextService.hasWorkspace() ? this.contextService.getWorkspace().roots : [];
        ...
        SearchViewlet.prototype.validateQuery = function (query) {
            ...
            return winjs_base_1.TPromise.join(folderQueriesExistP).then(function (existResults) {
                var nonExistantFolders = existResults.map(function (exists, i) { return ({ exists: exists, query: query.folderQueries[i] }); })
                    .filter(function (folderExists) { return !folderExists.exists; });
                if (nonExistantFolders.length) {
                    var nonExistantPath = nonExistantFolders[0].query.folder.fsPath;
        ...
        SearchViewlet.prototype.onQueryTriggered = function (query, excludePatternText, includePatternText) {
            ...
            this.showEmptyStage();
            var isDone = false;
            var outputChannel = this.outputService.getChannel('search');
                ...
                if (!hasResults) {
                    ...
                    if (!completed) {
                        ...
                        builder_1.$(p).a({
                            ...
                            dom.EventHelper.stop(e, false);
                            var editorPromise = _this.contextService.hasWorkspace() ? _this.preferencesService.openWorkspaceSettings() : _this.preferencesService.openGlobalSettings();
        ...
        SearchViewlet = __decorate([
            ...
            __param(16, listService_1.IListService),
            __param(17, themeService_1.IThemeService),
            __param(18, output_1.IOutputService)
        ], SearchViewlet);
