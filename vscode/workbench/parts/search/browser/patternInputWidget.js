...
define(["require", "exports", "vs/nls", "vs/base/browser/dom", "vs/base/browser/builder", "vs/base/browser/ui/widget", "vs/base/browser/ui/checkbox/checkbox", "vs/base/browser/ui/inputbox/inputBox", "vs/base/common/event", "vs/platform/theme/common/styler", "vs/base/common/history"], function (require, exports, nls, dom, builder_1, widget_1, checkbox_1, inputBox_1, event_1, styler_1, history_1) {
    ...
    var ExcludePatternInputWidget = (function (_super) {
        __extends(ExcludePatternInputWidget, _super);
        function ExcludePatternInputWidget(parent, contextViewProvider, themeService, telemetryService, options) {
            if (options === void 0) { options = Object.create(null); }
            var _this = _super.call(this, parent, contextViewProvider, themeService, options) || this;
        ...
        ExcludePatternInputWidget.prototype.useExcludeSettings = function () {
            return this.useExcludeSettingsBox.checked;
        };
        ExcludePatternInputWidget.prototype.setUseExcludeSettings = function (value) {
            this.useExcludeSettingsBox.checked = value;
        };
        ExcludePatternInputWidget.prototype.useIgnoreFiles = function () {
            return this.useIgnoreFilesBox.checked;
        };
        ExcludePatternInputWidget.prototype.setUseIgnoreFiles = function (value) {
            this.useIgnoreFilesBox.checked = value;
        };
        ExcludePatternInputWidget.prototype.getSubcontrolsWidth = function () {
            return _super.prototype.getSubcontrolsWidth.call(this) + this.useIgnoreFilesBox.width() + this.useExcludeSettingsBox.width();
        };
        ExcludePatternInputWidget.prototype.renderSubcontrols = function (controlsDiv) {
            var _this = this;
            this.useIgnoreFilesBox = new checkbox_1.Checkbox({
                actionClassName: 'useIgnoreFiles',
                title: nls.localize('useIgnoreFilesDescription', "Use Ignore Files"),
                isChecked: false,
                onChange: function (viaKeyboard) {
                    _this.telemetryService.publicLog('search.useIgnoreFiles.toggled');
                    _this.onOptionChange(null);
                    if (!viaKeyboard) {
            ...
            this._register(styler_1.attachCheckboxStyler(this.useIgnoreFilesBox, this.themeService));
            this.useExcludeSettingsBox = new checkbox_1.Checkbox({
                actionClassName: 'useExcludeSettings',
                title: nls.localize('useExcludeSettingsDescription', "Use Exclude Settings"),
                isChecked: false,
                onChange: function (viaKeyboard) {
                    _this.telemetryService.publicLog('search.useExcludeSettings.toggled');
                    _this.onOptionChange(null);
                    if (!viaKeyboard) {
                        _this.inputBox.focus();
                    }
            ...
            this._register(styler_1.attachCheckboxStyler(this.useExcludeSettingsBox, this.themeService));
