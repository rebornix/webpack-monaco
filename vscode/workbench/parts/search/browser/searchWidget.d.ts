...
export declare class SearchWidget extends Widget {
    ...
    constructor(container: Builder, options: ISearchWidgetOptions, contextViewService: IContextViewService, themeService: IThemeService, keyBindingService: IContextKeyService, keyBindingService2: IKeybindingService);
