...
define(["require", "exports", "vs/base/common/winjs.base", "vs/nls", "vs/base/common/actions", "vs/workbench/parts/output/common/output", "vs/base/browser/ui/actionbar/actionbar", "vs/workbench/services/part/common/partService", "vs/workbench/services/panel/common/panelService", "vs/workbench/browser/panel", "vs/base/common/lifecycle", "vs/platform/theme/common/styler", "vs/platform/theme/common/themeService"], function (require, exports, winjs_base_1, nls, actions_1, output_1, actionbar_1, partService_1, panelService_1, panel_1, lifecycle_1, styler_1, themeService_1) {
    /*---------------------------------------------------------------------------------------------
    ...
    var SwitchOutputActionItem = (function (_super) {
        ...
        function SwitchOutputActionItem(action, outputService, themeService) {
            var _this = _super.call(this, null, action, [], 0) || this;
            _this.outputService = outputService;
            _this.toDispose.push(_this.outputService.onOutputChannel(function () {
                var activeChannelIndex = _this.getSelected(_this.outputService.getActiveChannel().id);
                _this.setOptions(_this.getOptions(), activeChannelIndex);
            }));
