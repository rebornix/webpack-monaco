...
define(["require", "exports", "vs/base/common/winjs.base", "vs/nls", "vs/base/common/arrays", "vs/base/common/types", "vs/base/common/platform", "vs/base/common/actions", "vs/base/common/errorMessage", "vs/base/parts/quickopen/common/quickOpen", "vs/base/parts/quickopen/browser/quickOpenModel", "vs/platform/actions/common/actions", "vs/platform/contextkey/common/contextkey", "vs/workbench/common/actionRegistry", "vs/platform/registry/common/platform", "vs/workbench/browser/quickopen", "vs/editor/common/editorCommon", "vs/base/common/filters", "vs/workbench/services/editor/common/editorService", "vs/platform/instantiation/common/instantiation", "vs/platform/message/common/message", "vs/platform/telemetry/common/telemetry", "vs/platform/keybinding/common/keybinding", "vs/platform/quickOpen/common/quickOpen", "vs/editor/common/editorCommonExtensions", "vs/platform/storage/common/storage", "vs/platform/lifecycle/common/lifecycle", "vs/base/common/event", "vs/base/common/map", "vs/platform/configuration/common/configuration"], function (require, exports, winjs_base_1, nls, arrays, types, platform_1, actions_1, errorMessage_1, quickOpen_1, quickOpenModel_1, actions_2, contextkey_1, actionRegistry_1, platform_2, quickopen_1, editorCommon_1, filters_1, editorService_1, instantiation_1, message_1, telemetry_1, keybinding_1, quickOpen_2, editorCommonExtensions_1, storage_1, lifecycle_1, event_1, map_1, configuration_1) {
    'use strict';
    ...
    var CommandsHistory = (function () {
        ...
        CommandsHistory.prototype.load = function () {
            ...
            commandHistory = new map_1.BoundedMap(this.commandHistoryLength, 1, deserializedCache);
        ...
        CommandsHistory.prototype.registerListeners = function () {
            var _this = this;
            this.configurationService.onDidUpdateConfiguration(function (e) { return _this.updateConfiguration(); });
        ...
        CommandsHistory.prototype.get = function (commandId) {
    ...
    var ClearCommandHistoryAction = (function (_super) {
        __extends(ClearCommandHistoryAction, _super);
        function ClearCommandHistoryAction(id, label, storageService, configurationService) {
            var _this = _super.call(this, id, label) || this;
        ...
        ClearCommandHistoryAction.prototype.run = function (context) {
            ...
            if (commandHistoryLength > 0) {
                commandHistory = new map_1.BoundedMap(commandHistoryLength);
                commandCounter = 1;
            }
            return winjs_base_1.TPromise.as(null);
        };
    ...
    var CommandPaletteEditorAction = (function (_super) {
        ...
        CommandPaletteEditorAction = __decorate([
            editorCommonExtensions_1.editorAction
        ], CommandPaletteEditorAction);
    ...
    var CommandEntry = (function (_super) {
        ...
        function CommandEntry(commandId, keybinding, label, meta, highlights, actionDescriptor, onBeforeRun, instantiationService, messageService, telemetryService) {
        ...
        CommandEntry.prototype.getAction = function () {
            return this.instantiationService.createInstance(this.actionDescriptor.syncDescriptor);
        };
    ...
    var CommandsHandler = (function (_super) {
        ...
        function CommandsHandler(editorService, instantiationService, keybindingService, menuService, contextKeyService, configurationService) {
            var _this = _super.call(this) || this;
            ...
            _this.configurationService.onDidUpdateConfiguration(function (e) { return _this.updateConfiguration(); });
        ...
        CommandsHandler.prototype.getResults = function (searchValue) {
            ...
            var menu = editorCommon_1.isCommonCodeEditor(activeEditorControl)
                ? activeEditorControl.invokeWithinContext(function (accessor) { return _this.menuService.createMenu(actions_2.MenuId.CommandPalette, accessor.get(contextkey_1.IContextKeyService)); })
                : this.menuService.createMenu(actions_2.MenuId.CommandPalette, this.contextKeyService);
            ...
            entries = entries.sort(function (elementA, elementB) {
                var counterA = _this.commandsHistory.get(elementA.getCommandId());
                var counterB = _this.commandsHistory.get(elementB.getCommandId());
            ...
            for (var i = 0; i < actionDescriptors.length; i++) {
                ...
                if (actionDescriptor.label) {
                    ...
                    if (labelHighlights || aliasHighlights) {
                        entries.push(this.instantiationService.createInstance(CommandEntry, actionDescriptor.id, this.keybindingService.lookupKeybinding(actionDescriptor.id), label, alias, { label: labelHighlights, alias: aliasHighlights }, actionDescriptor, function (id) { return _this.onBeforeRunCommand(id); }));
                    }
                }
            }
            return entries;
