...
define(["require", "exports", "vs/base/common/winjs.base", "vs/nls", "vs/base/common/types", "vs/base/common/errors", "vs/base/parts/quickopen/common/quickOpen", "vs/base/parts/quickopen/browser/quickOpenModel", "vs/workbench/browser/quickopen", "vs/editor/common/editorCommon", "vs/workbench/services/editor/common/editorService", "vs/platform/quickOpen/common/quickOpen", "vs/editor/common/services/codeEditorService", "vs/editor/common/view/editorColorRegistry", "vs/platform/theme/common/themeService"], function (require, exports, winjs_base_1, nls, types, errors, quickOpen_1, quickOpenModel_1, quickopen_1, editorCommon_1, editorService_1, quickOpen_2, codeEditorService_1, editorColorRegistry_1, themeService_1) {
    /*---------------------------------------------------------------------------------------------
    ...
    var GotoLineAction = (function (_super) {
        ...
        function GotoLineAction(actionId, actionLabel, quickOpenService) {
            return _super.call(this, actionId, actionLabel, exports.GOTO_LINE_PREFIX, quickOpenService) || this;
        }
