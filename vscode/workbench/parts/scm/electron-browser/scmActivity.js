...
define(["require", "exports", "vs/nls", "vs/base/common/lifecycle", "vs/base/common/event", "vs/workbench/parts/scm/common/scm", "vs/workbench/services/scm/common/scm", "vs/workbench/services/activity/common/activityBarService", "vs/platform/contextkey/common/contextkey", "vs/platform/statusbar/common/statusbar"], function (require, exports, nls_1, lifecycle_1, event_1, scm_1, scm_2, activityBarService_1, contextkey_1, statusbar_1) {
    'use strict';
    ...
    var StatusUpdater = (function () {
        ...
        StatusUpdater.prototype.onDidAddRepository = function (repository) {
            var _this = this;
            var changeDisposable = repository.provider.onDidChange(function () { return _this.render(); });
        ...
        StatusUpdater.prototype.render = function () {
            ...
            var count = this.scmService.repositories.reduce(function (r, repository) {
                if (typeof repository.provider.count === 'number') {
                    ...
                    return r + repository.provider.resources.reduce(function (r, g) { return r + g.resources.length; }, 0);
                }
            }, 0);
            if (count > 0) {
                ...
                this.badgeDisposable = this.activityBarService.showActivity(scm_1.VIEWLET_ID, badge, 'scm-viewlet-label');
            }
            else {
                this.badgeDisposable = lifecycle_1.empty;
            }
    ...
    var StatusBarController = (function () {
        ...
        StatusBarController.prototype.getId = function () {
        ...
        StatusBarController.ID = 'vs.scm.statusBarController';
