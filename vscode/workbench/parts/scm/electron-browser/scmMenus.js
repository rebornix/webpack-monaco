...
define(["require", "exports", "vs/base/common/event", "vs/base/common/lifecycle", "vs/platform/contextkey/common/contextkey", "vs/platform/actions/common/actions", "vs/platform/actions/browser/menuItemActionItem", "./scmUtil", "vs/css!./media/scmViewlet"], function (require, exports, event_1, lifecycle_1, contextkey_1, actions_1, menuItemActionItem_1, scmUtil_1) {
    'use strict';
    Object.defineProperty(exports, "__esModule", { value: true });
    var SCMMenus = (function () {
        function SCMMenus(provider, contextKeyService, menuService) {
        ...
        SCMMenus.prototype.updateTitleActions = function () {
            ...
            menuItemActionItem_1.fillInActions(this.titleMenu, { shouldForwardArgs: true }, { primary: this.titleActions, secondary: this.titleSecondaryActions });
        ...
        SCMMenus.prototype.getActions = function (menuId, resource) {
            ...
            menuItemActionItem_1.fillInActions(menu, { shouldForwardArgs: true }, result, function (g) { return g === 'inline'; });
            menu.dispose();
