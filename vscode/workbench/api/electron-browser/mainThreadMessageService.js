...
define(["require", "exports", "vs/nls", "vs/platform/message/common/message", "vs/base/common/actions", "vs/base/common/winjs.base", "../node/extHost.protocol", "vs/workbench/api/electron-browser/extHostCustomers", "vs/platform/extensions/common/extensions"], function (require, exports, nls, message_1, actions_1, winjs_base_1, extHost_protocol_1, extHostCustomers_1, extensions_1) {
    /*---------------------------------------------------------------------------------------------
    ...
    var MainThreadMessageService = (function () {
        function MainThreadMessageService(extHostContext, _extensionService, _messageService, _choiceService) {
