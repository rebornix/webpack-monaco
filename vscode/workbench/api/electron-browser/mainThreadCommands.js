...
define(["require", "exports", "vs/platform/commands/common/commands", "vs/base/common/winjs.base", "../node/extHost.protocol", "vs/workbench/api/electron-browser/extHostCustomers"], function (require, exports, commands_1, winjs_base_1, extHost_protocol_1, extHostCustomers_1) {
    /*---------------------------------------------------------------------------------------------
    ...
    var MainThreadCommands = (function () {
        function MainThreadCommands(extHostContext, _commandService) {
            ...
            this._proxy = extHostContext.get(extHost_protocol_1.ExtHostContext.ExtHostCommands);
