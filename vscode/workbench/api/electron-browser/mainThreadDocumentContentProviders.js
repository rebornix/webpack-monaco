...
define(["require", "exports", "vs/editor/common/services/codeEditorService", "vs/workbench/services/group/common/groupService", "../node/extHost.protocol", "vs/editor/common/services/resolverService", "vs/editor/common/services/modeService", "vs/editor/common/services/modelService", "vs/workbench/api/electron-browser/extHostCustomers"], function (require, exports, codeEditorService_1, groupService_1, extHost_protocol_1, resolverService_1, modeService_1, modelService_1, extHostCustomers_1) {
    /*---------------------------------------------------------------------------------------------
    ...
    var MainThreadDocumentContentProviders = (function () {
        function MainThreadDocumentContentProviders(extHostContext, _textModelResolverService, _modeService, _modelService, codeEditorService, editorGroupService) {
            ...
            this._proxy = extHostContext.get(extHost_protocol_1.ExtHostContext.ExtHostDocumentContentProviders);
        }
