...
define(["require", "exports", "vs/base/common/errorMessage", "vs/editor/common/services/modelService", "vs/base/common/lifecycle", "vs/workbench/services/textfile/common/textfiles", "vs/base/common/winjs.base", "vs/platform/files/common/files", "vs/editor/common/services/modeService", "vs/workbench/services/untitled/common/untitledEditorService", "../node/extHost.protocol", "vs/editor/common/services/resolverService"], function (require, exports, errorMessage_1, modelService_1, lifecycle_1, textfiles_1, winjs_base_1, files_1, modeService_1, untitledEditorService_1, extHost_protocol_1, resolverService_1) {
    /*---------------------------------------------------------------------------------------------
    ...
    var BoundModelReferenceCollection = (function () {
    ...
    var MainThreadDocuments = (function () {
        function MainThreadDocuments(documentsAndEditors, extHostContext, modelService, modeService, textFileService, fileService, textModelResolverService, untitledEditorService) {
            ...
            this._proxy = extHostContext.get(extHost_protocol_1.ExtHostContext.ExtHostDocuments);
            this._modelIsSynced = {};
            this._toDispose = [];
            ...
            this._toDispose.push(textFileService.models.onModelReverted(function (e) {
                if (_this._shouldHandleFileEvent(e)) {
                    _this._proxy.$acceptDirtyStateChanged(e.resource.toString(), false);
                }
            }));
            this._toDispose.push(textFileService.models.onModelDirty(function (e) {
                if (_this._shouldHandleFileEvent(e)) {
                    _this._proxy.$acceptDirtyStateChanged(e.resource.toString(), true);
                }
            }));
        ...
        MainThreadDocuments.prototype._onModelAdded = function (model) {
            ...
            this._modelToDisposeMap[modelUrl.toString()] = model.onDidChangeContent(function (e) {
                _this._proxy.$acceptModelChanged(modelUrl.toString(), e, _this._textFileService.isDirty(modelUrl));
            });
        };
        ...
        MainThreadDocuments.prototype._handleUnititledScheme = function (uri) {
            var _this = this;
            var asFileUri = uri.with({ scheme: 'file' });
        ...
        MainThreadDocuments.prototype._doCreateUntitled = function (resource, modeId, initialValue) {
            ...
            return this._untitledEditorService.loadOrCreate({ resource: resource, modeId: modeId, initialValue: initialValue }).then(function (model) {
                ...
                _this._proxy.$acceptDirtyStateChanged(resource.toString(), true); // mark as dirty
                return resource;
            });
        };
