define(["require", "exports", "assert", "vs/editor/common/core/editOperation", "vs/editor/common/core/position", "vs/editor/common/core/range", "vs/editor/common/model/textModelEvents", "vs/editor/common/model/model"], function (require, exports, assert, editOperation_1, position_1, range_1, textModelEvents_1, model_1) {
    /*---------------------------------------------------------------------------------------------
    ...
    suite('Editor Model - Model', function () {
        ...
        test('model insert text with one newline eventing', function () {
            ...
            thisModel.applyEdits([editOperation_1.EditOperation.insert(new position_1.Position(1, 3), ' new line\nNo longer')]);
            assert.deepEqual(e, new textModelEvents_1.ModelRawContentChangedEvent([
                new textModelEvents_1.ModelRawLineChanged(1, 'My new line First Line'),
        ...
        test('model delete text from two lines eventing', function () {
            ...
            thisModel.applyEdits([editOperation_1.EditOperation.delete(new range_1.Range(1, 4, 2, 6))]);
            assert.deepEqual(e, new textModelEvents_1.ModelRawContentChangedEvent([
                new textModelEvents_1.ModelRawLineChanged(1, 'My '),
    ...
    suite('Editor Model - Model Line Separators', function () {
        ...
        test('Bug 13333:Model should line break on lonely CR too', function () {
            var model = model_1.Model.createFromString('Hello\rWorld!\r\nAnother line');
    ...
    suite('Editor Model - Words', function () {
        ...
        setup(function () {
            ...
            thisModel = model_1.Model.createFromString(text.join('\n'));
        });
        teardown(function () {
            thisModel.dispose();
        });
