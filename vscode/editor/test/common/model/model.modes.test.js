define(["require", "exports", "assert", "vs/editor/common/core/editOperation", "vs/editor/common/core/position", "vs/editor/common/core/range", "vs/editor/common/model/model", "vs/editor/common/modes", "vs/editor/common/modes/nullMode", "vs/editor/common/core/token"], function (require, exports, assert, editOperation_1, position_1, range_1, model_1, modes, nullMode_1, token_1) {
    /*---------------------------------------------------------------------------------------------
    ...
    suite('Editor Model - Model Modes 1', function () {
        ...
        setup(function () {
            ...
            thisModel = model_1.Model.createFromString(TEXT, undefined, new modes.LanguageIdentifier(LANGUAGE_ID, 0));
        });
        teardown(function () {
            thisModel.dispose();
            thisModel = null;
