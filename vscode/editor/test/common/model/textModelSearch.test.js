define(["require", "exports", "assert", "vs/editor/common/core/position", "vs/editor/common/editorCommon", "vs/editor/common/core/range", "vs/editor/common/model/textModel", "vs/editor/common/model/textModelSearch", "vs/editor/common/controller/wordCharacterClassifier", "vs/editor/common/model/wordHelper"], function (require, exports, assert, position_1, editorCommon_1, range_1, textModel_1, textModelSearch_1, wordCharacterClassifier_1, wordHelper_1) {
    /*---------------------------------------------------------------------------------------------
    ...
    suite('TextModelSearch', function () {
        ...
        function assertFindMatch(actual, expectedRange, expectedMatches) {
            ...
            assert.deepEqual(actual, new editorCommon_1.FindMatch(expectedRange, expectedMatches));
        }
        ...
        function assertFindMatches(text, searchString, isRegex, matchCase, wordSeparators, _expected) {
            ...
            var expectedMatches = expectedRanges.map(function (entry) { return new editorCommon_1.FindMatch(entry, null); });
            ...
            model2.setEOL(editorCommon_1.EndOfLineSequence.CRLF);
        ...
        test('findMatches with capturing matches', function () {
            ...
            assert.deepEqual(actual, [
                new editorCommon_1.FindMatch(new range_1.Range(1, 5, 1, 9), ['line', 'line', 'in']),
                new editorCommon_1.FindMatch(new range_1.Range(1, 10, 1, 14), ['line', 'line', 'in']),
                new editorCommon_1.FindMatch(new range_1.Range(2, 5, 2, 9), ['line', 'line', 'in']),
            ]);
            model.dispose();
        });
        test('findMatches multiline with capturing matches', function () {
            ...
            var actual = textModelSearch_1.TextModelSearch.findMatches(model, searchParams, model.getFullModelRange(), true, 100);
            assert.deepEqual(actual, [
                new editorCommon_1.FindMatch(new range_1.Range(1, 10, 2, 1), ['line\n', 'line', 'in']),
                new editorCommon_1.FindMatch(new range_1.Range(2, 5, 3, 1), ['line\n', 'line', 'in']),
            ]);
            model.dispose();
        });
