 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/editor/common/core/range", "vs/editor/common/editorCommon", "vs/editor/common/model/editableTextModel", "vs/editor/common/model/mirrorModel", "vs/editor/test/common/model/editableTextModelTestUtils"], function (require, exports, assert, range_1, editorCommon_1, editableTextModel_1, mirrorModel_1, editableTextModelTestUtils_1) {
    'use strict';
    ...
    suite('EditorModel - EditableTextModel._toSingleEditOperation', function () {
        ...
        function testSimpleApplyEdits(original, edits, expected) {
            var model = editableTextModel_1.EditableTextModel.createFromString(original.join('\n'));
    ...
    suite('EditorModel - EditableTextModel.applyEdits', function () {
        ...
        test('issue #1580: Changes in line endings are not correctly reflected in the extension host, leading to invalid offsets sent to external refactoring tools', function () {
            var model = editableTextModel_1.EditableTextModel.createFromString('Hello\nWorld!');
    ...
    suite('EditorModel - EditableTextModel.applyEdits & markers', function () {
        ...
        function testApplyEditsAndMarkers(text, markers, edits, changedMarkers, expectedText, expectedMarkers) {
            ...
            var model = editableTextModel_1.EditableTextModel.createFromString(textStr);
            model.setEOL(editorCommon_1.EndOfLineSequence.LF);
            // Add markers
            markers.forEach(function (m) {
                var modelMarkerId = model._addMarker(0, m.lineNumber, m.column, m.stickToPreviousCharacter);
