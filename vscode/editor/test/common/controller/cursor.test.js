...
define(["require", "exports", "assert", "vs/editor/common/controller/cursor", "vs/editor/common/core/editOperation", "vs/editor/common/core/position", "vs/editor/common/core/range", "vs/editor/common/core/selection", "vs/editor/common/editorCommon", "vs/editor/common/model/model", "vs/editor/common/modes/languageConfiguration", "vs/editor/common/modes/languageConfigurationRegistry", "vs/editor/test/common/mocks/testConfiguration", "vs/editor/test/common/mocks/mockMode", "vs/editor/common/modes", "vs/editor/common/controller/coreCommands", "vs/editor/test/common/mocks/mockCodeEditor", "vs/editor/common/model/textModel", "vs/editor/common/viewModel/viewModelImpl"], function (require, exports, assert, cursor_1, editOperation_1, position_1, range_1, selection_1, editorCommon_1, model_1, languageConfiguration_1, languageConfigurationRegistry_1, testConfiguration_1, mockMode_1, modes_1, coreCommands_1, mockCodeEditor_1, textModel_1, viewModelImpl_1) {
    /*---------------------------------------------------------------------------------------------
    ...
    var IndentRulesMode = (function (_super) {
    ...
    suite('Editor Controller - Regression tests', function () {
        ...
        test('Bug #11476: Double bracket surrounding + undo is broken', function () {
            ...
            usingCursor({
                ...
                modelOpts: { tabSize: 4, insertSpaces: true, detectIndentation: false, defaultEOL: editorCommon_1.DefaultEndOfLine.LF, trimAutoWhitespace: true }
        ...
        test('issue #12950: Cannot Double Click To Insert Emoji Using OSX Emoji Panel', function () {
            usingCursor({
                ...
                modelOpts: { insertSpaces: true, tabSize: 4, detectIndentation: false, defaultEOL: editorCommon_1.DefaultEndOfLine.LF, trimAutoWhitespace: true }
            }, function (model, cursor) {
    ...
    suite('Editor Controller - Cursor Configuration', function () {
        ...
        test('UseTabStops is off', function () {
            ...
            mockCodeEditor_1.withMockCodeEditor(null, { model: model, useTabStops: false }, function (editor, cursor) {
        ...
        test('Backspace removes whitespaces with tab size', function () {
            ...
            mockCodeEditor_1.withMockCodeEditor(null, { model: model, useTabStops: true }, function (editor, cursor) {
                ...
                coreCommands_1.CoreEditingCommands.DeleteLeft.runEditorCommand(null, editor, null);
                assert.equal(model.getValue(editorCommon_1.EndOfLinePreference.LF), 'x\n        a   ');
        ...
        test('PR #5423: Auto indent + undo + redo is funky', function () {
            ...
            mockCodeEditor_1.withMockCodeEditor(null, { model: model }, function (editor, cursor) {
                ...
                assert.equal(model.getValue(editorCommon_1.EndOfLinePreference.LF), '\nx', 'assert9');
                coreCommands_1.CoreEditingCommands.DeleteLeft.runEditorCommand(null, editor, null);
                assert.equal(model.getValue(editorCommon_1.EndOfLinePreference.LF), 'x', 'assert10');
                cursorCommand(cursor, H.Undo, {});
                assert.equal(model.getValue(editorCommon_1.EndOfLinePreference.LF), '\nx', 'assert11');
                cursorCommand(cursor, H.Undo, {});
                assert.equal(model.getValue(editorCommon_1.EndOfLinePreference.LF), '\n\ty\nx', 'assert12');
                ...
                assert.equal(model.getValue(editorCommon_1.EndOfLinePreference.LF), '\nx', 'assert15');
                cursorCommand(cursor, H.Redo, {});
                assert.equal(model.getValue(editorCommon_1.EndOfLinePreference.LF), 'x', 'assert16');
            });
            model.dispose();
        });
    });
    suite('Editor Controller - Indentation Rules', function () {
        ...
        test('Enter honors increaseIndentPattern', function () {
            usingCursor({
                ...
                languageIdentifier: mode.getLanguageIdentifier(),
                modelOpts: { insertSpaces: false, tabSize: 4, detectIndentation: false, defaultEOL: editorCommon_1.DefaultEndOfLine.LF, trimAutoWhitespace: true },
        ...
        test('Enter honors indentNextLinePattern 2', function () {
            ...
            mockCodeEditor_1.withMockCodeEditor(null, { model: model, autoIndent: true }, function (editor, cursor) {
        ...
        test('Enter should not adjust cursor position when press enter in the middle of a line 3', function () {
            usingCursor({
                ...
                languageIdentifier: mode.getLanguageIdentifier(),
                modelOpts: { insertSpaces: true, tabSize: 2, detectIndentation: false, defaultEOL: editorCommon_1.DefaultEndOfLine.LF, trimAutoWhitespace: true }
            }, function (model, cursor) {
    ...
    function usingCursor(opts, callback) {
        var model = model_1.Model.createFromString(opts.text.join('\n'), opts.modelOpts, opts.languageIdentifier);
        model.forceTokenization(model.getLineCount());
    ...
    var ElectricCharMode = (function (_super) {
    ...
    suite('autoClosingPairs', function () {
        var AutoClosingMode = (function (_super) {
