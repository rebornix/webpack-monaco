define(["require", "exports", "assert", "vs/editor/common/core/position", "vs/editor/common/viewModel/characterHardWrappingLineMapper", "vs/editor/common/viewModel/prefixSumComputer", "vs/editor/common/viewModel/splitLinesCollection", "vs/editor/test/common/mocks/testConfiguration", "vs/editor/common/model/model", "vs/editor/common/core/uint", "vs/editor/common/modes", "vs/editor/common/modes/nullMode", "vs/editor/common/core/token", "vs/editor/common/core/range"], function (require, exports, assert, position_1, characterHardWrappingLineMapper_1, prefixSumComputer_1, splitLinesCollection_1, testConfiguration_1, model_1, uint_1, modes, nullMode_1, token_1, range_1) {
    /*---------------------------------------------------------------------------------------------
    ...
    suite('SplitLinesCollection', function () {
        ...
        function assertViewLineTokens(actual, expected) {
            var _actual = actual.map(function (token) {
                return {
