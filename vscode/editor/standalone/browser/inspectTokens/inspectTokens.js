...
define(["require", "exports", "vs/nls", "vs/base/common/lifecycle", "vs/base/common/strings", "vs/editor/common/editorCommonExtensions", "vs/editor/browser/editorBrowser", "vs/editor/browser/editorBrowserExtensions", "vs/editor/common/services/modeService", "vs/editor/common/model/tokensBinaryEncoding", "vs/editor/common/modes", "vs/editor/standalone/common/standaloneThemeService", "vs/editor/common/modes/nullMode", "vs/base/common/color", "vs/platform/theme/common/themeService", "vs/platform/theme/common/colorRegistry", "vs/css!./inspectTokens"], function (require, exports, nls, lifecycle_1, strings_1, editorCommonExtensions_1, editorBrowser_1, editorBrowserExtensions_1, modeService_1, tokensBinaryEncoding_1, modes_1, standaloneThemeService_1, nullMode_1, color_1, themeService_1, colorRegistry_1) {
    /*---------------------------------------------------------------------------------------------
    ...
    var InspectTokensController = (function (_super) {
        ...
        InspectTokensController_1 = InspectTokensController;
