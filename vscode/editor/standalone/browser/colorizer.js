define(["require", "exports", "vs/base/common/winjs.base", "vs/editor/common/modes", "vs/editor/common/viewLayout/viewLineRenderer", "vs/editor/common/core/viewLineToken", "vs/editor/common/core/lineTokens", "vs/base/common/strings"], function (require, exports, winjs_base_1, modes_1, viewLineRenderer_1, viewLineToken_1, lineTokens_1, strings) {
    /*---------------------------------------------------------------------------------------------
    ...
    function _fakeColorize(lines, tabSize) {
        ...
        for (var i = 0, length_1 = lines.length; i < length_1; i++) {
            var line = lines[i];
            var renderResult = viewLineRenderer_1.renderViewLine2(new viewLineRenderer_1.RenderLineInput(false, line, false, 0, [new viewLineToken_1.ViewLineToken(line.length, defaultMetadata)], [], tabSize, 0, -1, 'none', false, false));
