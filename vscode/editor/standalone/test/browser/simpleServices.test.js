...
define(["require", "exports", "assert", "vs/platform/contextkey/browser/contextKeyService", "vs/editor/standalone/browser/simpleServices", "vs/platform/instantiation/common/instantiationService", "vs/platform/instantiation/common/serviceCollection"], function (require, exports, assert, contextKeyService_1, simpleServices_1, instantiationService_1, serviceCollection_1) {
    ...
    suite('StandaloneKeybindingService', function () {
        var TestStandaloneKeybindingService = (function (_super) {
        ...
        test('issue Microsoft/monaco-editor#167', function () {
            ...
            var keybindingService = new TestStandaloneKeybindingService(contextKeyService, commandService, messageService, domElement);
