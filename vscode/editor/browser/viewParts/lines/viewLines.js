...
define(["require", "exports", "vs/base/common/async", "vs/editor/common/core/range", "vs/editor/common/core/position", "vs/editor/browser/view/viewLayer", "vs/editor/browser/viewParts/lines/viewLine", "vs/editor/browser/config/configuration", "vs/editor/common/view/renderingContext", "vs/editor/browser/view/viewPart", "vs/editor/common/view/viewEvents", "vs/css!./viewLines"], function (require, exports, async_1, range_1, position_1, viewLayer_1, viewLine_1, configuration_1, renderingContext_1, viewPart_1, viewEvents) {
    ...
    var HorizontalRevealRequest = (function () {
        function HorizontalRevealRequest(lineNumber, startColumn, endColumn, startScrollTop, stopScrollTop) {
    ...
    var ViewLines = (function (_super) {
        ...
        ViewLines.prototype.onRevealRangeRequest = function (e) {
            var desiredScrollTop = this._computeScrollTopToRevealRange(this._context.viewLayout.getCurrentViewport(), e.range, e.verticalType);
