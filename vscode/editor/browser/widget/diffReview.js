...
define(["require", "exports", "vs/nls", "vs/base/common/lifecycle", "vs/base/browser/dom", "vs/base/browser/fastDomNode", "vs/editor/common/viewLayout/viewLineRenderer", "vs/editor/common/core/viewLineToken", "vs/editor/browser/config/configuration", "vs/editor/common/core/position", "vs/platform/theme/common/themeService", "vs/platform/theme/common/colorRegistry", "vs/base/browser/ui/scrollbar/scrollableElement", "vs/editor/common/view/editorColorRegistry", "vs/base/browser/ui/actionbar/actionbar", "vs/base/common/actions", "vs/editor/common/editorCommonExtensions", "vs/platform/contextkey/common/contextkey", "vs/editor/common/services/codeEditorService", "vs/css!./media/diffReview"], function (require, exports, nls, lifecycle_1, dom, fastDomNode_1, viewLineRenderer_1, viewLineToken_1, configuration_1, position_1, themeService_1, colorRegistry_1, scrollableElement_1, editorColorRegistry_1, actionbar_1, actions_1, editorCommonExtensions_1, contextkey_1, codeEditorService_1) {
    /*---------------------------------------------------------------------------------------------
    ...
    var DiffReview = (function (_super) {
        ...
        DiffReview.prototype.accept = function () {
            ...
            if (jumpToLineNumber !== -1) {
                ...
                this._diffEditor.revealPosition(new position_1.Position(jumpToLineNumber, 1));
            }
        };
    ...
    var DiffReviewNext = (function (_super) {
        ...
        DiffReviewNext = __decorate([
            editorCommonExtensions_1.editorAction
        ], DiffReviewNext);
        return DiffReviewNext;
    }(editorCommonExtensions_1.EditorAction));
    var DiffReviewPrev = (function (_super) {
