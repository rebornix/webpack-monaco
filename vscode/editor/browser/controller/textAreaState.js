define(["require", "exports", "vs/editor/common/core/range", "vs/editor/common/core/position", "vs/editor/common/editorCommon", "vs/base/common/strings"], function (require, exports, range_1, position_1, editorCommon_1, strings) {
    /*---------------------------------------------------------------------------------------------
    ...
    var TextAreaState = (function () {
        ...
        TextAreaState.prototype.equals = function (other) {
            if (other instanceof TextAreaState) {
                return (this.value === other.value
                    && this.selectionStart === other.selectionStart
                    && this.selectionEnd === other.selectionEnd
                    && position_1.Position.equals(this.selectionStartPosition, other.selectionStartPosition)
                    && position_1.Position.equals(this.selectionEndPosition, other.selectionEndPosition));
            }
            return false;
        };
    ...
    var PagedScreenReaderStrategy = (function () {
        ...
        PagedScreenReaderStrategy.fromEditorSelection = function (previousState, model, selection) {
