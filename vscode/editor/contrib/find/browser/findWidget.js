...
define(["require", "exports", "vs/nls", "vs/base/common/errors", "vs/base/common/platform", "vs/base/common/strings", "vs/base/browser/dom", "vs/base/browser/ui/findinput/findInput", "vs/base/browser/ui/inputbox/inputBox", "vs/base/browser/ui/widget", "vs/base/browser/ui/sash/sash", "vs/editor/browser/editorBrowser", "vs/editor/contrib/find/common/findModel", "vs/editor/common/core/range", "vs/editor/contrib/find/common/findController", "vs/platform/theme/common/themeService", "vs/platform/theme/common/colorRegistry", "vs/css!./findWidget"], function (require, exports, nls, errors_1, platform, strings, dom, findInput_1, inputBox_1, widget_1, sash_1, editorBrowser_1, findModel_1, range_1, findController_1, themeService_1, colorRegistry_1) {
    ...
    var FindWidgetViewZone = (function () {
    ...
    var FindWidget = (function (_super) {
        ...
        function FindWidget(codeEditor, controller, state, contextViewProvider, keybindingService, contextKeyService, themeService) {
            ...
            var checkEditorWidth = function () {
                ...
                var minimapWidth = _this._codeEditor.getConfiguration().layoutInfo.minimapWidth;
                var collapsedFindWidget = false;
                var reducedFindWidget = false;
                var narrowFindWidget = false;
                var widgetWidth = dom.getTotalWidth(_this._domNode);
                if (widgetWidth > FIND_WIDGET_INITIAL_WIDTH) {
                    // as the widget is resized by users, we may need to change the max width of the widget as the editor width changes.
                    _this._domNode.style.maxWidth = editorWidth - 28 - minimapWidth - 15 + "px";
                    _this._replaceInputBox.inputElement.style.width = dom.getTotalWidth(_this._findInput.inputBox.inputElement) + "px";
                    return;
                }
                ...
                var findInputWidth = dom.getTotalWidth(_this._findInput.inputBox.inputElement);
                if (findInputWidth > 0) {
                    _this._replaceInputBox.inputElement.style.width = findInputWidth + "px";
                }
            };
            checkEditorWidth();
            ...
            _this._findInputFocused = findController_1.CONTEXT_FIND_INPUT_FOCUSED.bindTo(contextKeyService);
        ...
        FindWidget.prototype._buildSash = function () {
            ...
            this._register(this._resizeSash.addListener('start', function (e) {
                originalWidth = dom.getTotalWidth(_this._domNode);
            }));
            this._register(this._resizeSash.addListener('change', function (evt) {
