...
define(["require", "exports", "vs/nls", "vs/base/browser/ui/widget", "vs/base/common/async", "vs/base/common/history", "vs/base/browser/dom", "vs/base/browser/ui/findinput/findInput", "vs/platform/contextview/browser/contextView", "vs/platform/theme/common/themeService", "vs/platform/theme/common/colorRegistry", "./findWidget", "vs/css!./simpleFindWidget"], function (require, exports, nls, widget_1, async_1, history_1, dom, findInput_1, contextView_1, themeService_1, colorRegistry_1, findWidget_1) {
    ...
    var SimpleFindWidget = (function (_super) {
        ...
        function SimpleFindWidget(_contextViewService, animate) {
            ...
            _this._domNode.classList.add('simple-find-part');
            _this._domNode.appendChild(_this._findInput.domNode);
            _this._domNode.appendChild(prevBtn.domNode);
            _this._domNode.appendChild(nextBtn.domNode);
            _this._domNode.appendChild(closeBtn.domNode);
            _this.onkeyup(_this._domNode, function (e) {
            ...
            _this._focusTracker = _this._register(dom.trackFocus(_this._domNode));
            _this._register(_this._focusTracker.addFocusListener(_this.onFocusTrackerFocus.bind(_this)));
            _this._register(_this._focusTracker.addBlurListener(_this.onFocusTrackerBlur.bind(_this)));
            _this._findInputFocusTracker = _this._register(dom.trackFocus(_this._findInput.domNode));
            _this._register(_this._findInputFocusTracker.addFocusListener(_this.onFindInputFocusTrackerFocus.bind(_this)));
            _this._register(_this._findInputFocusTracker.addBlurListener(_this.onFindInputFocusTrackerBlur.bind(_this)));
            _this._register(dom.addDisposableListener(_this._domNode, 'click', function (event) {
