...
define(["require", "exports", "vs/nls", "vs/base/common/errors", "vs/base/common/lifecycle", "vs/base/common/severity", "vs/platform/editor/common/editor", "vs/base/common/event", "vs/platform/instantiation/common/instantiation", "vs/platform/contextkey/common/contextkey", "vs/platform/message/common/message", "vs/platform/telemetry/common/telemetry", "vs/platform/configuration/common/configuration", "vs/platform/workspace/common/workspace", "vs/platform/storage/common/storage", "vs/editor/browser/editorBrowserExtensions", "vs/editor/contrib/zoneWidget/browser/peekViewWidget", "./referencesWidget", "vs/editor/common/services/resolverService", "vs/platform/theme/common/themeService", "vs/editor/common/core/position", "vs/platform/environment/common/environment"], function (require, exports, nls, errors_1, lifecycle_1, severity_1, editor_1, event_1, instantiation_1, contextkey_1, message_1, telemetry_1, configuration_1, workspace_1, storage_1, editorBrowserExtensions_1, peekViewWidget_1, referencesWidget_1, resolverService_1, themeService_1, position_1, environment_1) {
    ...
    var ReferencesController = (function () {
        function ReferencesController(editor, contextKeyService, _editorService, _textModelResolverService, _telemetryService, _messageService, _instantiationService, _contextService, _storageService, _themeService, _configurationService, _peekViewService, _environmentService) {
        ...
        ReferencesController.prototype.toggleWidget = function (range, modelPromise, options) {
            ...
            var mode = this._editor.getModel().getLanguageIdentifier().language;
        ...
        ReferencesController = ReferencesController_1 = __decorate([
            ...
            __param(11, instantiation_1.optional(peekViewWidget_1.IPeekViewService)),
            __param(12, instantiation_1.optional(environment_1.IEnvironmentService))
