 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "vs/editor/common/core/selection", "vs/editor/contrib/indentation/common/indentation", "vs/editor/test/common/commands/commandTestUtils"], function (require, exports, selection_1, indentation_1, commandTestUtils_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    function testIndentationToSpacesCommand(lines, selection, tabSize, expectedLines, expectedSelection) {
        commandTestUtils_1.testCommand(lines, null, selection, function (sel) { return new indentation_1.IndentationToSpacesCommand(sel, tabSize); }, expectedLines, expectedSelection);
    }
    function testIndentationToTabsCommand(lines, selection, tabSize, expectedLines, expectedSelection) {
        commandTestUtils_1.testCommand(lines, null, selection, function (sel) { return new indentation_1.IndentationToTabsCommand(sel, tabSize); }, expectedLines, expectedSelection);
    }
