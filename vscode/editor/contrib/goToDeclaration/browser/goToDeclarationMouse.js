...
define(["require", "exports", "vs/nls", "vs/base/common/async", "vs/base/common/errors", "vs/base/common/htmlContent", "vs/base/common/winjs.base", "vs/editor/common/services/modeService", "vs/editor/common/core/range", "vs/editor/common/modes", "vs/editor/browser/editorBrowser", "vs/editor/browser/editorBrowserExtensions", "./goToDeclaration", "vs/base/common/lifecycle", "vs/editor/common/services/resolverService", "vs/platform/theme/common/themeService", "vs/platform/theme/common/colorRegistry", "vs/editor/common/core/editorState", "./goToDeclarationCommands", "vs/editor/contrib/goToDeclaration/browser/clickLinkGesture", "vs/css!./goToDeclarationMouse"], function (require, exports, nls, async_1, errors_1, htmlContent_1, winjs_base_1, modeService_1, range_1, modes_1, editorBrowser_1, editorBrowserExtensions_1, goToDeclaration_1, lifecycle_1, resolverService_1, themeService_1, colorRegistry_1, editorState_1, goToDeclarationCommands_1, clickLinkGesture_1) {
    'use strict';
    ...
    var GotoDefinitionWithMouseEditorContribution = (function () {
        ...
        GotoDefinitionWithMouseEditorContribution_1 = GotoDefinitionWithMouseEditorContribution;
            ...
            this.throttler.queue(function () {
                ...
                if (results.length > 1) {
                    ...
                    _this.textModelResolverService.createModelReference(result_1.uri).then(function (ref) {
                        ...
                        var maxLineNumber = Math.min(textEditorModel.getLineCount(), startLineNumber + GotoDefinitionWithMouseEditorContribution_1.MAX_SOURCE_PREVIEW_LINES);
        ...
        var GotoDefinitionWithMouseEditorContribution_1;
    }());
...
//# sourceMappingURL=goToDeclarationMouse.js.map