...
define(["require", "exports", "vs/nls", "vs/base/common/errors", "vs/base/common/platform", "vs/base/common/severity", "vs/base/common/winjs.base", "vs/platform/message/common/message", "vs/platform/opener/common/opener", "vs/editor/common/editorCommon", "vs/editor/common/editorCommonExtensions", "vs/editor/common/modes", "vs/editor/common/services/editorWorkerService", "vs/editor/browser/editorBrowser", "vs/editor/contrib/links/common/links", "vs/base/common/lifecycle", "vs/editor/browser/editorBrowserExtensions", "vs/platform/theme/common/themeService", "vs/platform/theme/common/colorRegistry", "vs/editor/common/model/textModelWithDecorations", "vs/editor/contrib/goToDeclaration/browser/clickLinkGesture", "vs/base/common/htmlContent", "vs/css!./links"], function (require, exports, nls, errors_1, platform, severity_1, winjs_base_1, message_1, opener_1, editorCommon, editorCommonExtensions_1, modes_1, editorWorkerService_1, editorBrowser_1, links_1, lifecycle_1, editorBrowserExtensions_1, themeService_1, colorRegistry_1, textModelWithDecorations_1, clickLinkGesture_1, htmlContent_1) {
    'use strict';
    ...
    var decoration = {
        meta: textModelWithDecorations_1.ModelDecorationOptions.register({
            stickiness: editorCommon.TrackedRangeStickiness.NeverGrowsWhenTypingAtEdges,
            inlineClassName: 'detected-link',
            hoverMessage: HOVER_MESSAGE_GENERAL_META
        }),
        metaActive: textModelWithDecorations_1.ModelDecorationOptions.register({
            stickiness: editorCommon.TrackedRangeStickiness.NeverGrowsWhenTypingAtEdges,
            inlineClassName: 'detected-link-active',
            hoverMessage: HOVER_MESSAGE_GENERAL_META
        }),
        alt: textModelWithDecorations_1.ModelDecorationOptions.register({
            stickiness: editorCommon.TrackedRangeStickiness.NeverGrowsWhenTypingAtEdges,
            inlineClassName: 'detected-link',
            hoverMessage: HOVER_MESSAGE_GENERAL_ALT
        }),
        altActive: textModelWithDecorations_1.ModelDecorationOptions.register({
            stickiness: editorCommon.TrackedRangeStickiness.NeverGrowsWhenTypingAtEdges,
            inlineClassName: 'detected-link-active',
            hoverMessage: HOVER_MESSAGE_GENERAL_ALT
        }),
        altCommand: textModelWithDecorations_1.ModelDecorationOptions.register({
            stickiness: editorCommon.TrackedRangeStickiness.NeverGrowsWhenTypingAtEdges,
            inlineClassName: 'detected-link',
            hoverMessage: HOVER_MESSAGE_COMMAND_ALT
        }),
        altCommandActive: textModelWithDecorations_1.ModelDecorationOptions.register({
            stickiness: editorCommon.TrackedRangeStickiness.NeverGrowsWhenTypingAtEdges,
            inlineClassName: 'detected-link-active',
            hoverMessage: HOVER_MESSAGE_COMMAND_ALT
        }),
        metaCommand: textModelWithDecorations_1.ModelDecorationOptions.register({
            stickiness: editorCommon.TrackedRangeStickiness.NeverGrowsWhenTypingAtEdges,
            inlineClassName: 'detected-link',
            hoverMessage: HOVER_MESSAGE_COMMAND_META
        }),
        metaCommandActive: textModelWithDecorations_1.ModelDecorationOptions.register({
            stickiness: editorCommon.TrackedRangeStickiness.NeverGrowsWhenTypingAtEdges,
            inlineClassName: 'detected-link-active',
            hoverMessage: HOVER_MESSAGE_COMMAND_META
        }),
    };
    var LinkOccurrence = (function () {
    ...
    var OpenLinkAction = (function (_super) {
        ...
        OpenLinkAction.prototype.run = function (accessor, editor) {
            ...
            var link = linkDetector.getLinkOccurrence(editor.getPosition());
            if (link) {
