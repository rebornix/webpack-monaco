...
define(["require", "exports", "vs/editor/common/core/selection", "vs/editor/contrib/linesOperations/common/moveLinesCommand", "vs/editor/test/common/commands/commandTestUtils", "vs/editor/test/common/mocks/mockMode", "vs/editor/common/modes", "vs/editor/common/modes/languageConfigurationRegistry"], function (require, exports, selection_1, moveLinesCommand_1, commandTestUtils_1, mockMode_1, modes_1, languageConfigurationRegistry_1) {
    /*---------------------------------------------------------------------------------------------
    ...
    function testMoveLinesDownCommand(lines, selection, expectedLines, expectedSelection) {
        commandTestUtils_1.testCommand(lines, null, selection, function (sel) { return new moveLinesCommand_1.MoveLinesCommand(sel, true, false); }, expectedLines, expectedSelection);
    }
    function testMoveLinesUpCommand(lines, selection, expectedLines, expectedSelection) {
        commandTestUtils_1.testCommand(lines, null, selection, function (sel) { return new moveLinesCommand_1.MoveLinesCommand(sel, false, false); }, expectedLines, expectedSelection);
    }
    function testMoveLinesDownWithIndentCommand(languageId, lines, selection, expectedLines, expectedSelection) {
        commandTestUtils_1.testCommand(lines, languageId, selection, function (sel) { return new moveLinesCommand_1.MoveLinesCommand(sel, true, true); }, expectedLines, expectedSelection);
    }
    function testMoveLinesUpWithIndentCommand(languageId, lines, selection, expectedLines, expectedSelection) {
        commandTestUtils_1.testCommand(lines, languageId, selection, function (sel) { return new moveLinesCommand_1.MoveLinesCommand(sel, false, true); }, expectedLines, expectedSelection);
    }
