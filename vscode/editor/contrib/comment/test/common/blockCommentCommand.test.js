define(["require", "exports", "vs/editor/common/core/selection", "vs/editor/contrib/comment/common/blockCommentCommand", "vs/editor/test/common/commands/commandTestUtils", "vs/editor/test/common/commentMode"], function (require, exports, selection_1, blockCommentCommand_1, commandTestUtils_1, commentMode_1) {
    /*---------------------------------------------------------------------------------------------
    ...
    function testBlockCommentCommand(lines, selection, expectedLines, expectedSelection) {
        ...
        commandTestUtils_1.testCommand(lines, mode.getLanguageIdentifier(), selection, function (sel) { return new blockCommentCommand_1.BlockCommentCommand(sel); }, expectedLines, expectedSelection);
        mode.dispose();
    }
