...
define(["require", "exports", "assert", "vs/editor/common/core/selection", "vs/editor/contrib/comment/common/lineCommentCommand", "vs/editor/test/common/commands/commandTestUtils", "vs/editor/test/common/commentMode", "vs/editor/common/modes", "vs/editor/common/modes/nullMode", "vs/editor/common/core/token", "vs/editor/test/common/mocks/mockMode", "vs/editor/common/modes/languageConfigurationRegistry"], function (require, exports, assert, selection_1, lineCommentCommand_1, commandTestUtils_1, commentMode_1, modes, nullMode_1, token_1, mockMode_1, languageConfigurationRegistry_1) {
    ...
    suite('Editor Contrib - Line Comment Command', function () {
        function testLineCommentCommand(lines, selection, expectedLines, expectedSelection) {
            ...
            commandTestUtils_1.testCommand(lines, mode.getLanguageIdentifier(), selection, function (sel) { return new lineCommentCommand_1.LineCommentCommand(sel, 4, 0 /* Toggle */); }, expectedLines, expectedSelection);
            mode.dispose();
        }
        function testAddLineCommentCommand(lines, selection, expectedLines, expectedSelection) {
            var mode = new commentMode_1.CommentMode({ lineComment: '!@#', blockComment: ['<!@#', '#@!>'] });
            commandTestUtils_1.testCommand(lines, mode.getLanguageIdentifier(), selection, function (sel) { return new lineCommentCommand_1.LineCommentCommand(sel, 4, 1 /* ForceAdd */); }, expectedLines, expectedSelection);
            mode.dispose();
        }
    ...
    suite('Editor Contrib - Line Comment in mixed modes', function () {
        ...
        function testLineCommentCommand(lines, selection, expectedLines, expectedSelection) {
            ...
            commandTestUtils_1.testCommand(lines, outerMode.getLanguageIdentifier(), selection, function (sel) { return new lineCommentCommand_1.LineCommentCommand(sel, 4, 0 /* Toggle */); }, expectedLines, expectedSelection);
            innerMode.dispose();
            outerMode.dispose();
        }
