define(["require", "exports", "assert", "vs/editor/common/core/selection", "vs/editor/common/core/range", "vs/editor/common/core/position", "vs/editor/contrib/snippet/browser/snippetSession", "vs/editor/test/common/mocks/mockCodeEditor", "vs/editor/common/model/model"], function (require, exports, assert, selection_1, range_1, position_1, snippetSession_1, mockCodeEditor_1, model_1) {
    /*---------------------------------------------------------------------------------------------
    ...
    suite('SnippetSession', function () {
        ...
        setup(function () {
            model = model_1.Model.createFromString('function foo() {\n    console.log(a);\n}');
