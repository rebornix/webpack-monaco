...
define(["require", "exports", "assert", "vs/editor/common/core/position", "vs/editor/common/core/selection", "vs/editor/contrib/snippet/browser/snippetController2", "vs/editor/test/common/mocks/mockCodeEditor", "vs/platform/contextkey/common/contextkey"], function (require, exports, assert, position_1, selection_1, snippetController2_1, mockCodeEditor_1, contextkey_1) {
    /*---------------------------------------------------------------------------------------------
    ...
    var TestSnippetController = (function (_super) {
        __extends(TestSnippetController, _super);
        function TestSnippetController(editor, _contextKeyService) {
            var _this = _super.call(this, editor, _contextKeyService) || this;
