define(["require", "exports", "assert", "vs/editor/common/core/selection", "vs/editor/contrib/snippet/browser/snippetController2", "vs/editor/test/common/mocks/mockCodeEditor", "vs/editor/common/model/model", "vs/platform/keybinding/test/common/mockKeybindingService"], function (require, exports, assert, selection_1, snippetController2_1, mockCodeEditor_1, model_1, mockKeybindingService_1) {
    /*---------------------------------------------------------------------------------------------
    ...
    suite('SnippetController2', function () {
        ...
        setup(function () {
            ...
            model = model_1.Model.createFromString('if\n    $state\nfi');
        ...
        test('creation', function () {
            var ctrl = new snippetController2_1.SnippetController2(editor, contextKeys);
