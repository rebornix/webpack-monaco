 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "vs/base/common/strings", "vs/editor/common/editorCommon", "vs/editor/common/core/editOperation", "./snippetParser", "vs/editor/common/core/selection", "vs/editor/common/core/range", "vs/base/common/arrays", "vs/base/common/lifecycle", "./snippetVariables", "vs/editor/common/model/textModelWithDecorations", "vs/css!./snippetSession"], function (require, exports, strings_1, editorCommon_1, editOperation_1, snippetParser_1, selection_1, range_1, arrays_1, lifecycle_1, snippetVariables_1, textModelWithDecorations_1) {
    'use strict';
    Object.defineProperty(exports, "__esModule", { value: true });
    var OneSnippet = (function () {
        ...
        Object.defineProperty(OneSnippet.prototype, "placeholderRanges", {
            get: function () {
                var _this = this;
                var ret = [];
                this._placeholderDecorations.forEach(function (id, placeholder) {
        ...
        OneSnippet._decor = {
            active: textModelWithDecorations_1.ModelDecorationOptions.register({ stickiness: editorCommon_1.TrackedRangeStickiness.AlwaysGrowsWhenTypingAtEdges, className: 'snippet-placeholder' }),
            inactive: textModelWithDecorations_1.ModelDecorationOptions.register({ stickiness: editorCommon_1.TrackedRangeStickiness.NeverGrowsWhenTypingAtEdges, className: 'snippet-placeholder' }),
            activeFinal: textModelWithDecorations_1.ModelDecorationOptions.register({ stickiness: editorCommon_1.TrackedRangeStickiness.NeverGrowsWhenTypingAtEdges, className: 'finish-snippet-placeholder' }),
            inactiveFinal: textModelWithDecorations_1.ModelDecorationOptions.register({ stickiness: editorCommon_1.TrackedRangeStickiness.NeverGrowsWhenTypingAtEdges, className: 'finish-snippet-placeholder' }),
        };
        return OneSnippet;
    }());
    exports.OneSnippet = OneSnippet;
    var SnippetSession = (function () {
        ...
        SnippetSession.adjustSelection = function (model, selection, overwriteBefore, overwriteAfter) {
            if (overwriteBefore !== 0 || overwriteAfter !== 0) {
                var startLineNumber = selection.startLineNumber, startColumn = selection.startColumn, endLineNumber = selection.endLineNumber, endColumn = selection.endColumn;
                startColumn -= overwriteBefore;
                endColumn += overwriteAfter;
                var range = model.validateRange(range_1.Range.plusRange(selection, {
        ...
        SnippetSession.createEditsAndSnippets = function (editor, template, overwriteBefore, overwriteAfter, enforceFinalTabstop) {
            ...
            // primary selection
            var indexedSelection = editor.getSelections()
            ...
            for (var _i = 0, indexedSelection_1 = indexedSelection; _i < indexedSelection_1.length; _i++) {
                var _a = indexedSelection_1[_i], selection = _a.selection, idx = _a.idx;
                ...
                var snippet = new snippetParser_1.SnippetParser()
                    ...
                    .resolveVariables(new snippetVariables_1.EditorSnippetVariableResolver(model, selection));
        ...
        SnippetSession.prototype.isSelectionWithinPlaceholders = function () {
            ...
            for (var _i = 0, _a = this._snippets; _i < _a.length; _i++) {
                var snippet = _a[_i];
                ranges.push.apply(ranges, snippet.placeholderRanges);
            }
            ...
            outer: for (var _b = 0, selections_1 = selections; _b < selections_1.length; _b++) {
