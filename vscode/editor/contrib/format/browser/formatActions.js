...
define(["require", "exports", "vs/nls", "vs/base/common/arrays", "vs/base/common/keyCodes", "vs/base/common/lifecycle", "vs/base/common/winjs.base", "vs/platform/contextkey/common/contextkey", "vs/editor/common/editorCommonExtensions", "vs/editor/common/modes", "../common/format", "../common/formatCommand", "vs/platform/commands/common/commands", "vs/editor/common/services/codeEditorService", "vs/editor/common/services/editorWorkerService", "vs/editor/common/core/characterClassifier", "vs/editor/common/core/range", "vs/base/browser/ui/aria/aria", "vs/editor/common/core/editorState", "vs/editor/common/editorContextKeys"], function (require, exports, nls, arrays_1, keyCodes_1, lifecycle_1, winjs_base_1, contextkey_1, editorCommonExtensions_1, modes_1, format_1, formatCommand_1, commands_1, codeEditorService_1, editorWorkerService_1, characterClassifier_1, range_1, aria_1, editorState_1, editorContextKeys_1) {
    /*---------------------------------------------------------------------------------------------
    ...
    var FormatOnType = (function () {
        ...
        FormatOnType.prototype.trigger = function (ch) {
            ...
            format_1.getOnTypeFormattingEdits(model, position, ch, {
                ...
                formatCommand_1.EditOperationsCommand.execute(_this.editor, edits);
    ...
    var FormatSelectionAction = (function (_super) {
        ...
        function FormatSelectionAction() {
            return _super.call(this, {
                ...
                alias: 'Format Code',
                precondition: contextkey_1.ContextKeyExpr.and(editorContextKeys_1.EditorContextKeys.writable, editorContextKeys_1.EditorContextKeys.hasDocumentSelectionFormattingProvider, editorContextKeys_1.EditorContextKeys.hasNonEmptySelection),
                kbOpts: {
                    kbExpr: editorContextKeys_1.EditorContextKeys.textFocus,
