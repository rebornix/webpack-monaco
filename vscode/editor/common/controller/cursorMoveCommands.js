define(["require", "exports", "vs/editor/common/controller/cursorCommon", "vs/editor/common/core/position", "vs/editor/common/core/range", "vs/editor/common/controller/cursorMoveOperations", "vs/editor/common/controller/cursorWordOperations", "vs/base/common/types"], function (require, exports, cursorCommon_1, position_1, range_1, cursorMoveOperations_1, cursorWordOperations_1, types) {
    ...
    var CursorMoveCommands = (function () {
        ...
        CursorMoveCommands.selectAll = function (context, cursor) {
            if (context.model.hasEditableRange()) {
                ...
                var editableRange = context.model.getEditableRange();
                ...
                if (!selection.equalsRange(editableRange)) {
                    ...
                    return cursorCommon_1.CursorState.fromModelState(new cursorCommon_1.SingleCursorState(new range_1.Range(editableRange.startLineNumber, editableRange.startColumn, editableRange.startLineNumber, editableRange.startColumn), 0, new position_1.Position(editableRange.endLineNumber, editableRange.endColumn), 0));
                }
            }
        ...
        CursorMoveCommands._moveLeft = function (context, cursors, inSelectionMode, noOfColumns) {
            ...
            for (var i = 0, len = cursors.length; i < len; i++) {
                var cursor = cursors[i];
                result[i] = cursorCommon_1.CursorState.fromViewState(cursorMoveOperations_1.MoveOperations.moveLeft(context.config, context.viewModel, cursor.viewState, inSelectionMode, noOfColumns));
            }
            return result;
        };
        ...
        CursorMoveCommands._moveRight = function (context, cursors, inSelectionMode, noOfColumns) {
            ...
            for (var i = 0, len = cursors.length; i < len; i++) {
                var cursor = cursors[i];
                result[i] = cursorCommon_1.CursorState.fromViewState(cursorMoveOperations_1.MoveOperations.moveRight(context.config, context.viewModel, cursor.viewState, inSelectionMode, noOfColumns));
            }
            return result;
        };
