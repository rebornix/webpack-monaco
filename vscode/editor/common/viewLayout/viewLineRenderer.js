define(["require", "exports", "vs/editor/common/core/viewLineToken", "vs/editor/common/viewLayout/lineDecorations", "vs/base/common/strings", "vs/editor/common/core/stringBuilder"], function (require, exports, viewLineToken_1, lineDecorations_1, strings, stringBuilder_1) {
    /*---------------------------------------------------------------------------------------------
    ...
    var RenderLineOutput2 = (function () {
        ...
        for (var partIndex = 0, tokensLen = parts.length; partIndex < tokensLen; partIndex++) {
            ...
            if (partRendersWhitespace) {
                var partContentCnt = 0;
                {
                    ...
                    var _charOffsetInPart = charOffsetInPart;
