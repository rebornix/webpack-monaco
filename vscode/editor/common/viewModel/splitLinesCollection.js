define(["require", "exports", "vs/editor/common/core/position", "vs/editor/common/core/selection", "vs/editor/common/core/range", "vs/editor/common/viewModel/prefixSumComputer", "vs/editor/common/viewModel/viewModel", "vs/editor/common/view/viewEvents", "vs/editor/common/model/textModelWithDecorations"], function (require, exports, position_1, selection_1, range_1, prefixSumComputer_1, viewModel_1, viewEvents, textModelWithDecorations_1) {
    /*---------------------------------------------------------------------------------------------
    ...
    var SplitLinesCollection = (function () {
        ...
        SplitLinesCollection.prototype.setHiddenAreas = function (_ranges) {
            ...
            for (var i = 0; i < newRanges.length; i++) {
                newDecorations.push({
                    range: newRanges[i],
                    options: textModelWithDecorations_1.ModelDecorationOptions.EMPTY
                });
            }
    ...
    var IdentityCoordinatesConverter = (function () {
        ...
        IdentityCoordinatesConverter.prototype._validSelection = function (selection) {
            var selectionStart = this._validPosition(new position_1.Position(selection.selectionStartLineNumber, selection.selectionStartColumn));
            var position = this._validPosition(new position_1.Position(selection.positionLineNumber, selection.positionColumn));
            return new selection_1.Selection(selectionStart.lineNumber, selectionStart.column, position.lineNumber, position.column);
        };
        // View -> Model conversion and related methods
        ...
        IdentityCoordinatesConverter.prototype.convertViewSelectionToModelSelection = function (viewSelection) {
        ...
        IdentityCoordinatesConverter.prototype.convertModelSelectionToViewSelection = function (modelSelection) {
    ...
    var IdentityLinesCollection = (function () {
        ...
        IdentityLinesCollection.prototype.getViewLineIndentGuide = function (viewLineNumber) {
            return 0;
        };
