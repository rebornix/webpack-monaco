...
define(["require", "exports", "vs/base/common/errors", "vs/base/common/lifecycle"], function (require, exports, errors, lifecycle_1) {
    ...
    var ViewCursorStateChangedEvent = (function () {
        function ViewCursorStateChangedEvent(selections, isInEditableRange) {
    ...
    var ViewRevealRangeRequestEvent = (function () {
        function ViewRevealRangeRequestEvent(range, verticalType, revealHorizontal) {
    ...
    var ViewThemeChangedEvent = (function () {
    ...
    var ViewEventEmitter = (function (_super) {
