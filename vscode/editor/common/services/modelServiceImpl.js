...
define(["require", "exports", "vs/nls", "vs/base/common/network", "vs/base/common/event", "vs/base/common/htmlContent", "vs/base/common/severity", "vs/base/common/winjs.base", "vs/platform/markers/common/markers", "vs/editor/common/core/range", "vs/editor/common/core/selection", "vs/editor/common/editorCommon", "vs/editor/common/model/model", "vs/base/common/platform", "vs/platform/configuration/common/configuration", "vs/editor/common/config/editorOptions", "vs/editor/common/modes/modesRegistry", "vs/editor/common/model/textSource", "vs/editor/common/model/textModelEvents", "vs/editor/common/model/textModelWithDecorations", "vs/base/common/diff/diff", "vs/editor/common/core/editOperation"], function (require, exports, nls, network, event_1, htmlContent_1, severity_1, winjs_base_1, markers_1, range_1, selection_1, editorCommon, model_1, platform, configuration_1, editorOptions_1, modesRegistry_1, textSource_1, textModelEvents, textModelWithDecorations_1, diff_1, editOperation_1) {
    /*---------------------------------------------------------------------------------------------
        ...
        ModelMarkerHandler._createDecorationOption = function (marker) {
            ...
            switch (marker.severity) {
                ...
                case severity_1.default.Info:
                    className = textModelWithDecorations_1.ClassName.EditorWarningDecoration;
                ...
                default:
                    className = textModelWithDecorations_1.ClassName.EditorErrorDecoration;
    ...
    var DEFAULT_EOL = (platform.isLinux || platform.isMacintosh) ? editorCommon.DefaultEndOfLine.LF : editorCommon.DefaultEndOfLine.CRLF;
    var ModelServiceImpl = (function () {
        function ModelServiceImpl(markerService, configurationService) {
            ...
            this._configurationServiceSubscription = this._configurationService.onDidUpdateConfiguration(function (e) { return _this._updateModelOptions(); });
        ...
        ModelServiceImpl.prototype.getCreationOptions = function (language, resource) {
            ...
            if (!creationOptions) {
                creationOptions = ModelServiceImpl._readModelOptions(this._configurationService.getConfiguration(null, { overrideIdentifier: language, resource: resource }));
        ...
        ModelServiceImpl.prototype._createModelData = function (value, languageIdentifier, resource) {
            ...
            var rawTextSource = (typeof value === 'string' ? textSource_1.RawTextSource.fromString(value) : value);
            var model = new model_1.Model(rawTextSource, options, languageIdentifier, resource);
        ...
        ModelServiceImpl.prototype.updateModel = function (model, value) {
            ...
            var textSource = textSource_1.TextSource.create(value, options.defaultEOL);
            ...
            model.pushEditOperations([new selection_1.Selection(1, 1, 1, 1)], ModelServiceImpl._computeEdits(model, textSource), function (inverseEditOperations) { return [new selection_1.Selection(1, 1, 1, 1)]; });
        };
        /**
         * Compute edits to bring `model` to the state of `textSource`.
         */
        ModelServiceImpl._computeEdits = function (model, textSource) {
            var modelLineSequence = new (function () {
                function class_1() {
                }
            ...
            var textSourceLineSequence = new (function () {
                function class_2() {
                }
        ...
        ModelServiceImpl.prototype._onModelEvents = function (modelData, events) {
            ...
            for (var i = 0, len = events.length; i < len; i++) {
                ...
                if (e.type === textModelEvents.TextModelEventType.ModelLanguageChanged) {
                    ...
                    var oldModeId = e.data.oldLanguage;
