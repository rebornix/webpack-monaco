...
define(["require", "exports", "assert", "vs/base/common/event", "vs/base/common/eventEmitter", "vs/base/common/errors", "vs/base/common/winjs.base"], function (require, exports, assert, event_1, eventEmitter_1, Errors, winjs_base_1) {
    /*---------------------------------------------------------------------------------------------
    ...
    (function (Samples) {
        ...
        var Document3b = (function () {
            ...
            Document3b.prototype.setText = function (value) {
                //...
                this._eventBus.emit(Document3b._didChange, value);
            };
            Document3b._didChange = 'this_is_hidden_from_consumers';
            return Document3b;
        }());
        Samples.Document3b = Document3b;
    })(Samples || (Samples = {}));
