define(["require", "exports", "assert", "vs/base/common/json", "vs/base/common/jsonErrorMessages"], function (require, exports, assert, json_1, jsonErrorMessages_1) {
    ...
    function assertNodeAtLocation(input, segments, expected) {
        var actual = json_1.findNodeAtLocation(input, segments);
        assert.deepEqual(actual ? json_1.getNodeValue(actual) : void 0, expected);
    }
    function assertLocation(input, expectedSegments, expectedNodeType, expectedCompleteProperty) {
        ...
        var actual = json_1.getLocation(input, offset);
        assert(actual);
    ...
    suite('JSON', function () {
        ...
        test('tree: find location', function () {
            var root = json_1.parseTree('{ "key1": { "key11": [ "val111", "val112" ] }, "key2": [ { "key21": false, "key22": 221 }, null, [{}] ] }');
