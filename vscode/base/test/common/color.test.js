...
define(["require", "exports", "assert", "vs/base/common/color"], function (require, exports, assert, color_1) {
    ...
    suite('Color', function () {
        ...
        test('getLighterColor', function () {
            ...
            assert.deepEqual(new color_1.HSLA(0, 0, 0.918, 1), color_1.Color.getLighterColor(color2, color1).hsla);
            assert.deepEqual(new color_1.HSLA(0, 0, 0.851, 1), color_1.Color.getLighterColor(color2, color1, 0.3).hsla);
            assert.deepEqual(new color_1.HSLA(0, 0, 0.980, 1), color_1.Color.getLighterColor(color2, color1, 0.7).hsla);
        ...
        test('getDarkerColor', function () {
            ...
            // Abyss theme
            assert.deepEqual(new color_1.HSLA(355, 0.875, 0.157, 1), color_1.Color.getDarkerColor(color_1.Color.fromHex('#770811'), color_1.Color.fromHex('#000c18'), 0.4).hsla);
        });
