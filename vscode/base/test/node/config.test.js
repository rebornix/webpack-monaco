 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "os", "path", "fs", "vs/base/node/extfs", "vs/base/common/uuid", "vs/base/node/config", "vs/base/test/common/utils"], function (require, exports, assert, os, path, fs, extfs, uuid, config_1, utils_1) {
    'use strict';
    ...
    suite('Config', function () {
        function testFile(callback) {
            ...
            extfs.mkdirp(newDir, 493, function (error) {
                callback(error, testFile, function (callback) { return extfs.del(parentDir, os.tmpdir(), function () { }, callback); });
            });
        }
