...
define(["require", "exports", "vs/base/browser/builder", "vs/base/common/winjs.base", "vs/base/browser/touch", "vs/base/common/actions", "vs/base/common/eventEmitter", "vs/base/common/lifecycle", "vs/base/browser/dom", "vs/css!./dropdown"], function (require, exports, builder_1, winjs_base_1, touch_1, actions_1, eventEmitter_1, lifecycle_1, dom_1) {
    'use strict';
    ...
    var BaseDropdown = (function (_super) {
        ...
        function BaseDropdown(container, options) {
            ...
            _this.$label.on([dom_1.EventType.CLICK, dom_1.EventType.MOUSE_DOWN, touch_1.EventType.Tap], function (e) {
                ...
                setTimeout(function () { return _this.show(); }, 100);
            }).appendTo(_this.$el);
            var cleanupFn = labelRenderer(_this.$label.getHTMLElement());
            if (cleanupFn) {
                _this._toDispose.push(cleanupFn);
            }
            _this._toDispose.push(new touch_1.Gesture(_this.$label.getHTMLElement()));
            return _this;
        }
