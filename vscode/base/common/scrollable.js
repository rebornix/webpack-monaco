...
define(["require", "exports", "vs/base/common/lifecycle", "vs/base/common/event"], function (require, exports, lifecycle_1, event_1) {
    ...
    var SmoothScrollingOperation = (function () {
        function SmoothScrollingOperation(from, to, duration) {
            this.from = from;
            this.to = to;
        ...
        SmoothScrollingOperation.prototype.tick = function () {
            var completion = (Date.now() - this._startTime) / this.duration;
            if (completion < 1) {
                var t = easeOutCubic(completion);
                var newScrollLeft = this.from.scrollLeft + (this.to.scrollLeft - this.from.scrollLeft) * t;
                var newScrollTop = this.from.scrollTop + (this.to.scrollTop - this.from.scrollTop) * t;
