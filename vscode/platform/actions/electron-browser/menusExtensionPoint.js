define(["require", "exports", "vs/base/common/uri", "vs/base/browser/dom", "vs/nls", "vs/base/common/strings", "path", "vs/base/common/idGenerator", "vs/base/common/collections", "vs/platform/extensions/common/extensionsRegistry", "vs/platform/contextkey/common/contextkey", "vs/platform/actions/common/actions"], function (require, exports, uri_1, dom_1, nls_1, strings_1, path_1, idGenerator_1, collections_1, extensionsRegistry_1, contextkey_1, actions_1) {
    /*---------------------------------------------------------------------------------------------
    ...
    extensionsRegistry_1.ExtensionsRegistry.registerExtensionPoint('commands', [], schema.commandsContribution).setHandler(function (extensions) {
        ...
        function handleCommand(userFriendlyCommand, extension) {
            ...
            if (icon) {
                ...
                if (typeof icon === 'string') {
                    var path = path_1.join(extension.description.extensionFolderPath, icon);
                    dom_1.createCSSRule(".icon." + iconClass, "background-image: url(\"" + uri_1.default.file(path).toString() + "\")");
                }
                else {
                    var light = path_1.join(extension.description.extensionFolderPath, icon.light);
                    var dark = path_1.join(extension.description.extensionFolderPath, icon.dark);
                    dom_1.createCSSRule(".icon." + iconClass, "background-image: url(\"" + uri_1.default.file(light).toString() + "\")");
                    dom_1.createCSSRule(".vs-dark .icon." + iconClass + ", .hc-black .icon." + iconClass, "background-image: url(\"" + uri_1.default.file(dark).toString() + "\")");
                }
            }
