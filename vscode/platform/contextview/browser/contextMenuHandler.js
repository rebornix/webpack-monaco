...
define(["require", "exports", "vs/base/browser/builder", "vs/base/common/lifecycle", "vs/base/browser/mouseEvent", "vs/base/common/actions", "vs/base/browser/ui/menu/menu", "vs/base/common/events", "vs/base/common/severity", "vs/css!./contextMenuHandler"], function (require, exports, builder_1, lifecycle_1, mouseEvent_1, actions_1, menu_1, events_1, severity_1) {
    ...
    var ContextMenuHandler = (function () {
        function ContextMenuHandler(element, contextViewService, telemetryService, messageService) {
            ...
            this.toDispose.push(this.actionRunner.addListener(events_1.EventType.BEFORE_RUN, function (e) {
            ...
            this.toDispose.push(this.actionRunner.addListener(events_1.EventType.RUN, function (e) {
                if (hideViewOnRun) {
                    _this.contextViewService.hideContextView(false);
                }
                hideViewOnRun = false;
            ...
            delegate.getActions().done(function (actions) {
                _this.contextViewService.showContextView({
                    ...
                    render: function (container) {
                        ...
                        var listener1 = menu.addListener(events_1.EventType.CANCEL, function (e) {
                            _this.contextViewService.hideContextView(true);
                        });
                        var listener2 = menu.addListener(events_1.EventType.BLUR, function (e) {
                            _this.contextViewService.hideContextView(true);
                        });
                        menu.focus();
