...
define(["require", "exports", "assert", "vs/base/common/keyCodes", "vs/platform/keybinding/common/abstractKeybindingService", "vs/platform/keybinding/common/usLayoutResolvedKeybinding", "vs/platform/keybinding/common/keybindingResolver", "vs/platform/contextkey/common/contextkey", "vs/base/common/winjs.base", "vs/platform/keybinding/common/resolvedKeybindingItem", "vs/base/common/platform"], function (require, exports, assert, keyCodes_1, abstractKeybindingService_1, usLayoutResolvedKeybinding_1, keybindingResolver_1, contextkey_1, winjs_base_1, resolvedKeybindingItem_1, platform_1) {
    /*---------------------------------------------------------------------------------------------
    ...
    suite('AbstractKeybindingService', function () {
        var TestKeybindingService = (function (_super) {
            ...
            function TestKeybindingService(resolver, contextKeyService, commandService, messageService, statusService) {
                var _this = _super.call(this, contextKeyService, commandService, messageService, statusService) || this;
