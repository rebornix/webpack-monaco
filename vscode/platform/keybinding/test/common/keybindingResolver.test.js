    ...
    suite('KeybindingResolver', function () {
        ...
        test('contextIsEntirelyIncluded', function () {
            var assertIsIncluded = function (a, b) {
                assert.equal(keybindingResolver_1.KeybindingResolver.whenIsEntirelyIncluded(false, new contextkey_1.ContextKeyAndExpr(a), new contextkey_1.ContextKeyAndExpr(b)), true);
            };
            var assertIsNotIncluded = function (a, b) {
                assert.equal(keybindingResolver_1.KeybindingResolver.whenIsEntirelyIncluded(false, new contextkey_1.ContextKeyAndExpr(a), new contextkey_1.ContextKeyAndExpr(b)), false);
            };
