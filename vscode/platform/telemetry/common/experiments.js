...
define(["require", "exports", "vs/platform/configuration/common/configuration", "vs/platform/storage/common/storage", "vs/platform/instantiation/common/instantiation"], function (require, exports, configuration_1, storage_1, instantiation_1) {
    /*---------------------------------------------------------------------------------------------
    ...
    function splitExperimentsRandomness(storageService) {
        ...
        var random2 = splitRandom(random1)[0];
        var _a = splitRandom(random2), deployToAzureQuickLink = _a[1];
        // const [random4, /* mergeQuickLinks */] = splitRandom(random3);
        // const [random5, /* enableWelcomePage */] = splitRandom(random4);
        return {
            deployToAzureQuickLink: deployToAzureQuickLink
        };
    }
